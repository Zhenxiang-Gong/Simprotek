...
namespace Prosimo.UnitOperations.HeatTransfer {
   ...
   public class Furnace : UnitOperation {
      ...
      private void Solve() {
         ...
         Substance carbon = catalog.GetSubstance(Substance.CARBON);
         Substance hydrogen = catalog.GetSubstance(Substance.HYDROGEN);
         Substance oxygen = catalog.GetSubstance(Substance.OXYGEN);
         Substance sulfur = catalog.GetSubstance(Substance.SULFUR);
         Substance air = catalog.GetSubstance(Substance.AIR);
         Substance carbonDioxide = catalog.GetSubstance(Substance.CARBON_DIOXIDE);
         Substance sulfurDioxide = catalog.GetSubstance(Substance.SULFUR_DIOXIDE);
         Substance water = catalog.GetSubstance(Substance.WATER);
         Substance nitrogen = catalog.GetSubstance(Substance.NITROGEN);
         Substance argon = catalog.GetSubstance(Substance.ARGON);
