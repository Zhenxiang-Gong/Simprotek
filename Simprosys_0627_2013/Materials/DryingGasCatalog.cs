...
namespace Prosimo.Materials {
   ...
   public class DryingGasCatalog {
      ...
      private void InitializeCatalog() {
         ...
         DryingGas dgAir = new DryingGas(Substance.AIR, sc.GetSubstance(Substance.AIR), false);
         gasList.Add(dgAir);
         //gasMoistureSubstanceListTable.Add(dgAir, sc.GetMoistureSubstanceListForAir());

         DryingGas dgNitrogen = new DryingGas("Nitrogen", sc.GetSubstance(Substance.NITROGEN), false);
