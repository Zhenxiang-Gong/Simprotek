...
namespace Prosimo {
   ...
   public abstract class StringConstants {
      ...
      // labels
      public const string GENERAL_MASS_FLOW_RATE = "GENERAL_MASS_FLOW_RATE";
      ...
      public const string PERCENT_HEAT_LOSS = "PERCENT_HEAT_LOSS";
      public const string TOTAL_HEAT_GENERATED = "TOTAL_HEAT_GENERATED";
      public const string FLUE_GAS_OXYGEN_MASS_FRACTION = "FLUE_GAS_OXYGEN_MASS_FRACTION";
      public const string FLUE_GAS_OXYGEN_MOLE_FRACTION = "FLUE_GAS_OXYGEN_MOLE_FRACTION";
      ...
      static StringConstants() {
         varTypeNameTable.Add(GENERAL_MASS_FLOW_RATE, "Mass Flow Rate");
         ...
         varTypeNameTable.Add(PERCENT_HEAT_LOSS, "Heat Loss %");
         varTypeNameTable.Add(TOTAL_HEAT_GENERATED, "Total Heat Generated");
         varTypeNameTable.Add(FLUE_GAS_OXYGEN_MASS_FRACTION, "Flue Gas Oxygen Mass Fraction");
         varTypeNameTable.Add(FLUE_GAS_OXYGEN_MOLE_FRACTION, "Flue Gas Oxygen Mole Fraction");
      }
