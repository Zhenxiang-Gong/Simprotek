...
namespace ProsimoUI.MaterialsUI
{
	...
	/// </summary>
	public class FossilFuelComponentsControl : System.Windows.Forms.UserControl
	{
      private INumericFormat iNumericFormat;

      private FossilFuelCache fossilFuelCache;
      public FossilFuelCache FossilFuelCache
      {
         get {return fossilFuelCache;}
      }
      ...
      public FossilFuelComponentsControl()
      {
      ...
      public void DeleteSelectedElements()
      {
         ...
         { 
            ...
            fossilFuelCache.RemoveMaterialComponent(element.MaterialComponent);
         }
      }
      ...
      private void fossilFuelCache_ComponentsChanged(ArrayList materialComponentList)
      {
