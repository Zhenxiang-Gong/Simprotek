...
namespace ProsimoUI.MaterialsUI {
   ...
   public class DryingMaterialsControl : System.Windows.Forms.UserControl {
      ...
      internal void Initialization()
      {
         ...
         DryingMaterialCatalog.Instance.DryingMaterialAdded += new DryingMaterialAddedEventHandler(DryingMaterialsControl_DryingMaterialAdded);
         DryingMaterialCatalog.Instance.DryingMaterialChanged += new DryingMaterialChangedEventHandler(DryingMaterialsControl_DryingMaterialChanged);
         DryingMaterialCatalog.Instance.DryingMaterialDeleted += new DryingMaterialDeletedEventHandler(DryingMaterialsControl_DryingMaterialDeleted);
      ...
      private void InitializeComponent() {
         ...
         // comboBoxTypes
         // 
         this.comboBoxTypes.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
         this.comboBoxTypes.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
         this.comboBoxTypes.Location = new System.Drawing.Point(135, 346);
         this.comboBoxTypes.Name = "comboBoxTypes";
         this.comboBoxTypes.Size = new System.Drawing.Size(122, 21);
         ...
         // labelFilterByType
         // 
         this.labelFilterByType.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
         this.labelFilterByType.Location = new System.Drawing.Point(-3, 345);
         this.labelFilterByType.Name = "labelFilterByType";
         this.labelFilterByType.Size = new System.Drawing.Size(133, 20);
         ...
         this.listViewMaterials.AutoArrange = false;
         ...
         this.listViewMaterials.Size = new System.Drawing.Size(450, 311);
         ...
         this.columnHeaderUserDefined.Width = 87;
         // 
         // columnHeaderType
         // 
         ...
         this.comboBoxUserDef.Location = new System.Drawing.Point(135, 317);
         this.comboBoxUserDef.Name = "comboBoxUserDef";
         this.comboBoxUserDef.Size = new System.Drawing.Size(122, 21);
         ...
         this.labelFilterByUserDef.Location = new System.Drawing.Point(-3, 316);
         this.labelFilterByUserDef.Name = "labelFilterByUserDef";
         this.labelFilterByUserDef.Size = new System.Drawing.Size(133, 20);
         ...
         this.Size = new System.Drawing.Size(457, 378);
      ...
      private void PopulateDryingMaterialList() {
         ...
         if (typeFilterStr.Equals(UI.STR_ALL) && userDefFilterStr.Equals(UI.STR_ALL)) {
            this.PopulateIt(DryingMaterialCatalog.Instance.GetDryingMaterialList());
         }
            ...
            this.PopulateIt(DryingMaterialCatalog.Instance.GetDryingMaterialList(userDef));
         }
         else if (!typeFilterStr.Equals(UI.STR_ALL) && userDefFilterStr.Equals(UI.STR_ALL)) {
            MaterialType type = DryingMaterialsControl.GetDryingMaterialTypeAsEnum(typeFilterStr);
            this.PopulateIt(DryingMaterialCatalog.Instance.GetDryingMaterialList(type));
         }
         else {
            bool userDef = UI.GetUserDefinedAsBool(userDefFilterStr);
            MaterialType type = DryingMaterialsControl.GetDryingMaterialTypeAsEnum(typeFilterStr);
            this.PopulateIt(DryingMaterialCatalog.Instance.GetDryingMaterialList(userDef, type));
         }
      }
      ...
      public DryingMaterial GetSelectedDryingMaterial() {
         ...
         if (this.listViewMaterials.SelectedItems.Count == 1) {
            ...
            dm = DryingMaterialCatalog.Instance.GetDryingMaterial(lvsi.Text);
         }
         return dm;
      }
      ...
      public void SelectDryingMaterial(string dryingMaterialName) {
         ...
         else if (this.listViewMaterials.Items.Count >0) {
            bool foundIt = false;
      ...
      public void DeleteSelectedElements() {
         ...
         while (en2.MoveNext()) {
            ...
            DryingMaterialCatalog.Instance.RemoveDryingMaterial(name);
         }
      }
   }
}
