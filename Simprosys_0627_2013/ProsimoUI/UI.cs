...
namespace ProsimoUI {
   ...
   public class UI {
      ...
      static UI() {
         ...
         solvableNameTable.Add(typeof(DetailedFuelStream), "Fuel Stream");
         solvableNameTable.Add(typeof(GenericFuelStream), "Fuel Stream");
         ...
         solvableNameTable.Add(typeof(Burner), "Burner");
      }
