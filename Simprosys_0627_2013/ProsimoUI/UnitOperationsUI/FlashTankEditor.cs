...
namespace ProsimoUI.UnitOperationsUI {
   ...
   public class FlashTankEditor : UnitOpEditor {
      ...
      public FlashTankEditor(FlashTankControl flashTankCtrl)
         : base(flashTankCtrl) {
         //
      ...
      protected override void UpdateStreamsUI()
      {
         ...
         if (hasInlet) {
            ...
            MaterialStreamValuesControl ctrl = new MaterialStreamValuesControl(matInCtrl);
            //ProcessStreamBaseControl matInCtrl = this.FlashTankCtrl.Flowsheet.StreamManager.GetProcessStreamBaseControl(this.FlashTankCtrl.FlashTank.Inlet.Name);
            //UserControl ctrl = new ProcessVarValuesControl(matInCtrl);
            this.groupBoxStreams.Controls.Add(ctrl);
         ...
         if (hasVaporOut) {
            UserControl ctrl = null;
            if (vaporOut is DryingMaterialStream) {
            ...
            //ProcessStreamBaseControl matOutCtrl = this.FlashTankCtrl.Flowsheet.StreamManager.GetProcessStreamBaseControl(this.FlashTankCtrl.FlashTank.VaporOutlet.Name);
            //UserControl ctrl = new ProcessVarValuesControl(matOutCtrl);
         ...
         if (hasLiquidOut) {
            ...
            //ProcessStreamBaseControl matOutCtrl = this.FlashTankCtrl.Flowsheet.StreamManager.GetProcessStreamBaseControl(this.FlashTankCtrl.FlashTank.LiquidOutlet.Name);
            //UserControl ctrl = new ProcessVarValuesControl(matOutCtrl);
