...
namespace ProsimoUI.UnitOperationsUI {
   ...
   public class UnitOpManager {
      ...
      public UnitOpControl GetUnitOpControl(string name) {
         ...
         foreach (Object obj in this.flowsheet.Controls) {
            if (obj is UnitOpControl) {
               UnitOpControl c = (UnitOpControl)obj;
               if (c.Solvable.Name.Equals(name)) {
                  uoCtrl = c;
                  break;
               }
            }
      ...
      public ArrayList GetShowableInEditorUnitOpControls<T>() {
         ...
         if (typeof(T).IsSubclassOf(typeof(UnitOperation))) {
            ArrayList ctrls = new ArrayList();
            IEnumerator e = this.flowsheet.EvaporationAndDryingSystem.GetSolvableList(typeof(T)).GetEnumerator();
            while (e.MoveNext()) {
      ...
      private void AddCtrlForDryerGasInlet(DryerControl uoCtrl) {
         if (uoCtrl.Dryer.GasInlet != null) {
            ...
            //Point locIn = CalculateLeftStreamLocation(uoCtrl, strCtrl, this.flowsheet.Height);
            Point locIn = CalculateLeftStreamLocation(uoCtrl, strCtrl);
      ...
      private void AddCtrlForDryerGasOutlet(DryerControl uoCtrl) {
         if (uoCtrl.Dryer.GasOutlet != null) {
            ...
            Point locOut = CalculateRightStreamLocation(uoCtrl, strCtrl);
      ...
      private void AddCtrlForDryerMaterialInlet(DryerControl uoCtrl) {
         if (uoCtrl.Dryer.MaterialInlet != null) {
            ...
            //Point locIn = CalculateUpStreamLocation(uoCtrl, strCtrl, this.flowsheet.Width);
            //strCtrl.Location = locIn; // this is a default location
            // give it a more left location 
            Point locIn = CalculateUpStreamLocation(uoCtrl, strCtrl);
      ...
      private void AddCtrlForDryerMaterialOutlet(DryerControl uoCtrl) {
         if (uoCtrl.Dryer.MaterialOutlet != null) {
            ...
            //Point locOut = CalculateDownStreamLocation(uoCtrl, strCtrl, this.flowsheet.Width, this.flowsheet.Height);
            //strCtrl.Location = locOut; // this is the default location
            Point locOut = CalculateDownStreamLocation(uoCtrl, strCtrl);
      ...
      private void AddCtrlForTwoStreamUnitOpInlet(TwoStreamUnitOpControl uoCtrl) {
         if (uoCtrl.TwoStreamUnitOp.Inlet != null) {
            ...
            else if (uoCtrl.TwoStreamUnitOp.Inlet is WaterStream) {
               strCtrl = new WaterStreamControl(this.flowsheet, uoCtrl.Location, (WaterStream)uoCtrl.TwoStreamUnitOp.Inlet);
            }
            //Point locIn = CalculateLeftStreamLocation(uoCtrl, strCtrl, this.flowsheet.Height);
            Point locIn = CalculateLeftStreamLocation(uoCtrl, strCtrl);
            // adjust for RecycleControl
            if (uoCtrl is RecycleControl)
               locIn = CalculateRightStreamLocation(uoCtrl, strCtrl);
            strCtrl.Location = locIn;
            this.flowsheet.Controls.Add(strCtrl);
      ...
      private void AddCtrlForTwoStreamUnitOpOutlet(TwoStreamUnitOpControl uoCtrl)
      {
         if(uoCtrl.TwoStreamUnitOp.Outlet != null)
         {
            ...
            else if(uoCtrl.TwoStreamUnitOp.Outlet is WaterStream)
            {
               strCtrl = new WaterStreamControl(this.flowsheet, uoCtrl.Location, (WaterStream)uoCtrl.TwoStreamUnitOp.Outlet);
            }
            //Point locOut = CalculateRightStreamLocation(uoCtrl, strCtrl, this.flowsheet.Width, this.flowsheet.Height);
            Point locOut = CalculateRightStreamLocation(uoCtrl, strCtrl);
            // adjust for RecycleControl
            if(uoCtrl is RecycleControl)
               //locOut = CalculateLeftStreamLocation(uoCtrl, strCtrl, this.flowsheet.Height);
               locOut = CalculateLeftStreamLocation(uoCtrl, strCtrl);
            strCtrl.Location = locOut;
            this.flowsheet.Controls.Add(strCtrl);
      ...
      private void AddCtrlForElectrostaticPrecipitatorParticleOutlet(ElectrostaticPrecipitatorControl uoCtrl)
      {
         if(uoCtrl.ElectrostaticPrecipitator.ParticleOutlet != null)
         {
            ProcessStreamBaseControl strCtrl = null;
            if(uoCtrl.ElectrostaticPrecipitator.ParticleOutlet is DryingMaterialStream)
            {
               strCtrl = new MaterialStreamControl(this.flowsheet, uoCtrl.Location, (DryingMaterialStream)uoCtrl.ElectrostaticPrecipitator.ParticleOutlet);
            }
            //Point locOut = CalculateDownStreamLocation(uoCtrl, strCtrl, this.flowsheet.Width, this.flowsheet.Height);
            //strCtrl.Location = locOut; // this is the default location
            Point locOut = CalculateDownStreamLocation(uoCtrl, strCtrl);
            ...
            strCtrl.Location = new Point(uoCtrl.Location.X + uoCtrl.Width, locOut.Y);
            this.flowsheet.Controls.Add(strCtrl);
            uoCtrl.CreateConnection(uoCtrl.ElectrostaticPrecipitator, strCtrl.ProcessStreamBase, BagFilter.PARTICLE_OUTLET_INDEX);
         }
      }

      private void AddCtrlForBagFilterInlet(BagFilterControl uoCtrl)
      {
         if(uoCtrl.BagFilter.GasInlet != null)
         {
            ProcessStreamBaseControl strCtrl = null;
            if(uoCtrl.BagFilter.GasInlet is DryingGasStream)
            {
               strCtrl = new GasStreamControl(this.flowsheet, uoCtrl.Location, (DryingGasStream)uoCtrl.BagFilter.GasInlet);
            }
            ...
            strCtrl.Location = locIn;
            this.flowsheet.Controls.Add(strCtrl);
            uoCtrl.CreateConnection(uoCtrl.BagFilter, strCtrl.ProcessStreamBase, BagFilter.INLET_INDEX);
         }
      }
      private void AddCtrlForBagFilterOutlet(BagFilterControl uoCtrl)
      {
         if(uoCtrl.BagFilter.GasOutlet != null)
         {
            ProcessStreamBaseControl strCtrl = null;
            if(uoCtrl.BagFilter.GasOutlet is DryingGasStream)
            {
               strCtrl = new GasStreamControl(this.flowsheet, uoCtrl.Location, (DryingGasStream)uoCtrl.BagFilter.GasOutlet);
            }
            Point locOut = CalculateRightStreamLocation(uoCtrl, strCtrl);

            strCtrl.Location = locOut;
            this.flowsheet.Controls.Add(strCtrl);
            uoCtrl.CreateConnection(uoCtrl.BagFilter, strCtrl.ProcessStreamBase, BagFilter.OUTLET_INDEX);
         }
      }

      private void AddCtrlForBagFilterParticleOutlet(BagFilterControl uoCtrl)
      {
         if(uoCtrl.BagFilter.ParticleOutlet != null)
         {
            ProcessStreamBaseControl strCtrl = null;
            if(uoCtrl.BagFilter.ParticleOutlet is DryingMaterialStream)
            {
               strCtrl = new MaterialStreamControl(this.flowsheet, uoCtrl.Location, (DryingMaterialStream)uoCtrl.BagFilter.ParticleOutlet);
            }
            //Point locOut = CalculateDownStreamLocation(uoCtrl, strCtrl, this.flowsheet.Width, this.flowsheet.Height);
            //strCtrl.Location = locOut; // this is the default location
            Point locOut = CalculateDownStreamLocation(uoCtrl, strCtrl);
            ...
            strCtrl.Location = new Point(uoCtrl.Location.X + uoCtrl.Width, locOut.Y);
            this.flowsheet.Controls.Add(strCtrl);
            uoCtrl.CreateConnection(uoCtrl.BagFilter, strCtrl.ProcessStreamBase, BagFilter.PARTICLE_OUTLET_INDEX);
         }
      }
       ...
       private void AddCtrlForCycloneGasInlet(CycloneControl uoCtrl) {
         if (uoCtrl.Cyclone.GasInlet != null) {
            ...
            strCtrl.Location = new Point(locIn.X, locIn.Y - 10);
            this.flowsheet.Controls.Add(strCtrl);
      ...
      private void AddCtrlForCycloneGasOutlet(CycloneControl uoCtrl) {
         if (uoCtrl.Cyclone.GasOutlet != null) {
            ...
            //}
            Point locOut = CalculateUpStreamLocation(uoCtrl, strCtrl);
            strCtrl.Location = locOut; // this is the default location
            // give it a more right location 
            strCtrl.Location = new Point(uoCtrl.Location.X + uoCtrl.Width, locOut.Y);
            this.flowsheet.Controls.Add(strCtrl);
      ...
      private void AddCtrlForEjectorMotiveInlet(EjectorControl uoCtrl) {
         if (uoCtrl.Ejector.MotiveInlet != null) {
            ...
            else if (uoCtrl.Ejector.MotiveInlet is WaterStream) {
               strCtrl = new WaterStreamControl(this.flowsheet, uoCtrl.Location, (WaterStream)uoCtrl.Ejector.MotiveInlet);
            }
      ...
      private void AddCtrlForEjectorSuctionInlet(EjectorControl uoCtrl) {
         if (uoCtrl.Ejector.SuctionInlet != null) {
            ...
            else if (uoCtrl.Ejector.SuctionInlet is WaterStream) {
               strCtrl = new WaterStreamControl(this.flowsheet, uoCtrl.Location, (WaterStream)uoCtrl.Ejector.SuctionInlet);
            }
            ...
            Point locIn = CalculateDownStreamLocation(uoCtrl, strCtrl);
      ...
      private void AddCtrlForEjectorDischargeOutlet(EjectorControl uoCtrl) {
         if (uoCtrl.Ejector.DischargeOutlet != null) {
            ...
            else if (uoCtrl.Ejector.DischargeOutlet is WaterStream) {
               strCtrl = new WaterStreamControl(this.flowsheet, uoCtrl.Location, (WaterStream)uoCtrl.Ejector.DischargeOutlet);
            }
      ...
      private void AddCtrlForHeatExchangerColdInlet(HeatExchangerControl uoCtrl) {
         if (uoCtrl.HeatExchanger.ColdSideInlet != null) {
            ...
            else if (uoCtrl.HeatExchanger.ColdSideInlet is WaterStream) {
               strCtrl = new WaterStreamControl(this.flowsheet, uoCtrl.Location, (WaterStream)uoCtrl.HeatExchanger.ColdSideInlet);
            }
            Point locIn = CalculateLeftStreamLocation(uoCtrl, strCtrl);
            strCtrl.Location = locIn;
            this.flowsheet.Controls.Add(strCtrl);
      ...
      private void AddCtrlForHeatExchangerColdOutlet(HeatExchangerControl uoCtrl) {
         if (uoCtrl.HeatExchanger.ColdSideOutlet != null) {
            ...
            else if (uoCtrl.HeatExchanger.ColdSideOutlet is WaterStream) {
               strCtrl = new WaterStreamControl(this.flowsheet, uoCtrl.Location, (WaterStream)uoCtrl.HeatExchanger.ColdSideOutlet);
            }
            Point locOut = CalculateRightStreamLocation(uoCtrl, strCtrl);
            strCtrl.Location = locOut;
            this.flowsheet.Controls.Add(strCtrl);
      ...
      private void AddCtrlForHeatExchangerHotInlet(HeatExchangerControl uoCtrl) {
         if (uoCtrl.HeatExchanger.HotSideInlet != null) {
            ...
            else if (uoCtrl.HeatExchanger.HotSideInlet is WaterStream) {
               strCtrl = new WaterStreamControl(this.flowsheet, uoCtrl.Location, (WaterStream)uoCtrl.HeatExchanger.HotSideInlet);
            }
            Point locIn = CalculateUpStreamLocation(uoCtrl, strCtrl);
            //strCtrl.Location = locIn;
            // give it a more left location 
      ...
      private void AddCtrlForHeatExchangerHotOutlet(HeatExchangerControl uoCtrl) {
         if (uoCtrl.HeatExchanger.HotSideOutlet != null) {
            ...
            else if (uoCtrl.HeatExchanger.HotSideOutlet is WaterStream) {
               strCtrl = new WaterStreamControl(this.flowsheet, uoCtrl.Location, (WaterStream)uoCtrl.HeatExchanger.HotSideOutlet);
            }
            Point locOut = CalculateDownStreamLocation(uoCtrl, strCtrl);
            //strCtrl.Location = locOut;
            // give it a more right location 
      ...
      private void AddCtrlForWetScrubberGasInlet(WetScrubberControl uoCtrl) {
         if (uoCtrl.WetScrubber.GasInlet != null) {
            ...
            else if (uoCtrl.WetScrubber.GasInlet is WaterStream) {
               strCtrl = new WaterStreamControl(this.flowsheet, uoCtrl.Location, (WaterStream)uoCtrl.WetScrubber.GasInlet);
            }
            Point locIn = CalculateLeftStreamLocation(uoCtrl, strCtrl);
            strCtrl.Location = locIn;
            this.flowsheet.Controls.Add(strCtrl);
      ...
      private void AddCtrlForWetScrubberGasOutlet(WetScrubberControl uoCtrl) {
         if (uoCtrl.WetScrubber.GasOutlet != null) {
            ...
            else if (uoCtrl.WetScrubber.GasOutlet is WaterStream) {
               strCtrl = new WaterStreamControl(this.flowsheet, uoCtrl.Location, (WaterStream)uoCtrl.WetScrubber.GasOutlet);
            }
            Point locOut = CalculateRightStreamLocation(uoCtrl, strCtrl);
            strCtrl.Location = locOut;
            this.flowsheet.Controls.Add(strCtrl);
      ...
      private void AddCtrlForWetScrubberLiquidInlet(WetScrubberControl uoCtrl) {
         if (uoCtrl.WetScrubber.LiquidInlet != null) {
            ...
            else if (uoCtrl.WetScrubber.LiquidInlet is WaterStream) {
               strCtrl = new WaterStreamControl(this.flowsheet, uoCtrl.Location, (WaterStream)uoCtrl.WetScrubber.LiquidInlet);
            }
            Point locIn = CalculateUpStreamLocation(uoCtrl, strCtrl);
            //strCtrl.Location = locIn;
            // give it a more left location 
      ...
      private void AddCtrlForScrubberCondenserGasInlet(ScrubberCondenserControl uoCtrl) {
         if (uoCtrl.ScrubberCondenser.GasInlet != null) {
            ...
            //}
            //Point locIn = CalculateLeftStreamLocation(uoCtrl, strCtrl, this.flowsheet.Height);
            Point locIn = CalculateLeftStreamLocation(uoCtrl, strCtrl, 2, 2);
            strCtrl.Location = locIn;
            this.flowsheet.Controls.Add(strCtrl);
      ...
      private void AddCtrlForScrubberCondenserGasOutlet(ScrubberCondenserControl uoCtrl) {
         if (uoCtrl.ScrubberCondenser.GasOutlet != null) {
            ...
            if (uoCtrl.ScrubberCondenser.GasOutlet is DryingGasStream) {
               strCtrl = new GasStreamControl(this.flowsheet, uoCtrl.Location, (DryingGasStream)uoCtrl.ScrubberCondenser.GasOutlet, StreamOrientation.Left);
            }
            //else if (uoCtrl.ScrubberCondenser.GasOutlet is ProcessStream) {
            //   strCtrl = new ProcessStreamControl(this.flowsheet, uoCtrl.Location, (ProcessStream)uoCtrl.ScrubberCondenser.GasOutlet, StreamOrientation.Left);
            //}
            //Point locOut = CalculateUpStreamLocation(uoCtrl, strCtrl, this.flowsheet.Width);
            Point locOut = CalculateLeftStreamLocation(uoCtrl, strCtrl, 1, 2);
            strCtrl.Location = locOut; // this is the default location
            // give it a more right location 
            //strCtrl.Location = new Point(uoCtrl.Location.X + uoCtrl.Width, locOut.Y);
            this.flowsheet.Controls.Add(strCtrl);
      ...
      private void AddCtrlForScrubberCondenserWaterInlet(ScrubberCondenserControl uoCtrl) {
         if (uoCtrl.ScrubberCondenser.WaterInlet != null) {
            ProcessStreamBaseControl strCtrl = null;
            if (uoCtrl.ScrubberCondenser.WaterInlet is WaterStream) {
               strCtrl = new WaterStreamControl(this.flowsheet, uoCtrl.Location, (WaterStream)uoCtrl.ScrubberCondenser.WaterInlet, StreamOrientation.Left);
            }
            else if (uoCtrl.ScrubberCondenser.WaterInlet is DryingMaterialStream) {
               strCtrl = new MaterialStreamControl(this.flowsheet, uoCtrl.Location, (DryingMaterialStream)uoCtrl.ScrubberCondenser.WaterInlet, StreamOrientation.Left);
            }
            Point locIn = CalculateRightStreamLocation(uoCtrl, strCtrl, 1, 2);
            strCtrl.Location = locIn;
            this.flowsheet.Controls.Add(strCtrl);
            uoCtrl.CreateConnection(uoCtrl.ScrubberCondenser, strCtrl.ProcessStreamBase, ScrubberCondenser.WATER_INLET_INDEX);
         }
      }

      private void AddCtrlForScrubberCondenserWaterOutlet(ScrubberCondenserControl uoCtrl) {
         if (uoCtrl.ScrubberCondenser.WaterOutlet != null) {
            ProcessStreamBaseControl strCtrl = null;
            if (uoCtrl.ScrubberCondenser.WaterOutlet is WaterStream) {
               strCtrl = new WaterStreamControl(this.flowsheet, uoCtrl.Location, (WaterStream)uoCtrl.ScrubberCondenser.WaterOutlet);
            }
            else if (uoCtrl.ScrubberCondenser.WaterOutlet is DryingMaterialStream) {
               strCtrl = new MaterialStreamControl(this.flowsheet, uoCtrl.Location, (DryingMaterialStream)uoCtrl.ScrubberCondenser.WaterOutlet);
            }
            Point locOut = CalculateRightStreamLocation(uoCtrl, strCtrl, 2, 2);
            strCtrl.Location = locOut; // this is the default location
            // give it a more right location 
            //strCtrl.Location = new Point(uoCtrl.Location.X + uoCtrl.Width, locOut.Y);
            this.flowsheet.Controls.Add(strCtrl);
            uoCtrl.CreateConnection(uoCtrl.ScrubberCondenser, strCtrl.ProcessStreamBase, ScrubberCondenser.WATER_OUTLET_INDEX);
         }
      }
      ...
      private void AddCtrlForBurnerAirInlet(BurnerControl uoCtrl) {
         if (uoCtrl.Burner.AirInlet != null) {
            GasStreamControl strCtrl = new GasStreamControl(this.flowsheet, uoCtrl.Location, uoCtrl.Burner.AirInlet);
            Point locIn = CalculateLeftStreamLocation(uoCtrl, strCtrl);
            //strCtrl.Location = locIn; // this is a default location
            // give it a more left location 
            strCtrl.Location = new Point(uoCtrl.Location.X - uoCtrl.Width, locIn.Y);
            this.flowsheet.Controls.Add(strCtrl);
            uoCtrl.CreateConnection(uoCtrl.Burner, strCtrl.ProcessStreamBase, Burner.AIR_INLET_INDEX);
         }
      }

      private void AddCtrlForBurnerFlueGasOutlet(BurnerControl uoCtrl) {
         if (uoCtrl.Burner.FlueGasOutlet != null) {
            GasStreamControl strCtrl = new GasStreamControl(this.flowsheet, uoCtrl.Location, uoCtrl.Burner.FlueGasOutlet);
            Point locOut = CalculateUpStreamLocation(uoCtrl, strCtrl);
            //strCtrl.Location = locOut; // this is the default location
            // give it a more right location 
            strCtrl.Location = new Point(uoCtrl.Location.X + uoCtrl.Width, locOut.Y);
            this.flowsheet.Controls.Add(strCtrl);
            uoCtrl.CreateConnection(uoCtrl.Burner, strCtrl.ProcessStreamBase, Burner.FLUE_GAS_OUTLET_INDEX);
         }
      }

      private void AddCtrlForBurnerFuelInlet(BurnerControl uoCtrl) {
         if (uoCtrl.Burner.FuelInlet != null) {
            DetailedFuelStreamControl strCtrl = new DetailedFuelStreamControl(this.flowsheet, uoCtrl.Location, (DetailedFuelStream)uoCtrl.Burner.FuelInlet);
            Point locOut = CalculateDownStreamLocation(uoCtrl, strCtrl);
            //strCtrl.Location = locOut; // this is the default location
            // give it a more right location 
            strCtrl.Location = new Point(uoCtrl.Location.X - uoCtrl.Width, locOut.Y);
            this.flowsheet.Controls.Add(strCtrl);
            uoCtrl.CreateConnection(uoCtrl.Burner, strCtrl.ProcessStreamBase, Burner.FUEL_INLET_INDEX);
         }
      }
      ...
      private void AddCtrlsForMixerInlets(MixerControl uoCtrl) {
         ...
         while (e.MoveNext()) {
            ...
            //}
            Point locIn = CalculateLeftStreamLocation(uoCtrl, strCtrl, k, n);
            strCtrl.Location = locIn;
            this.flowsheet.Controls.Add(strCtrl);
      ...
      private void AddCtrlsForTeeOutlets(TeeControl uoCtrl) {
         ...
         while (e.MoveNext()) {
            ...
            //   strCtrl = new ProcessStreamControl(this.flowsheet, uoCtrl.Location, (ProcessStream)processStreamBase);
            //}
            Point locOut = CalculateRightStreamLocation(uoCtrl, strCtrl, k, n);
            strCtrl.Location = locOut;
            this.flowsheet.Controls.Add(strCtrl);
      ...
      private void EvaporationAndDryingSystem_UnitOpAdded(UnitOperation uo) {
         ...
         if (uo is Dryer) {
            ...
            this.AddCtrlForScrubberCondenserWaterInlet(scrubberCondenserCtrl);
            this.AddCtrlForScrubberCondenserWaterOutlet(scrubberCondenserCtrl);
         }
         else if (uo is Mixer) {
            ...
            this.AddCtrlForBagFilterInlet(bagFilterCtrl);
            this.AddCtrlForBagFilterOutlet(bagFilterCtrl);
            this.AddCtrlForBagFilterParticleOutlet(bagFilterCtrl);
         }
         ...
         else if (uo is Burner) {
            BurnerControl burnerCtrl = new BurnerControl(this.flowsheet, location, uo as Burner);
            this.flowsheet.Controls.Add(burnerCtrl);

            this.AddCtrlForBurnerAirInlet(burnerCtrl);
            this.AddCtrlForBurnerFuelInlet(burnerCtrl);
            this.AddCtrlForBurnerFlueGasOutlet(burnerCtrl);
         }
            ...
            this.AddCtrlForElectrostaticPrecipitatorParticleOutlet(electrostaticPrecipitatorCtrl);
         }
         else if (uo is Pump) {
      ...
      public void RecallInitialization()
      {
         foreach(object unitOpCtrl in this.flowsheet.Controls)
         {
            if(unitOpCtrl is BagFilterControl)
            {
               this.AddConnectionForBagFilterParticleOutlet(unitOpCtrl as BagFilterControl);
            }
            else if(unitOpCtrl is ElectrostaticPrecipitatorControl)
            {
               this.AddConnectionForElectrostaticPrecipitatorParticleOutlet(unitOpCtrl as ElectrostaticPrecipitatorControl);
            }
         }
      }

      private void AddConnectionForBagFilterParticleOutlet(BagFilterControl uoCtrl)
      {
         if(uoCtrl.BagFilter.ParticleOutlet != null)
         {
            ProcessStreamBaseControl strCtrl = uoCtrl.Flowsheet.StreamManager.GetProcessStreamBaseControl(uoCtrl.BagFilter.ParticleOutlet.Name);
            strCtrl.Location = new Point(uoCtrl.Location.X + uoCtrl.Width, uoCtrl.Location.Y + uoCtrl.Height + UI.DELTA_H);
            uoCtrl.CreateConnection(uoCtrl.BagFilter, strCtrl.ProcessStreamBase, BagFilter.PARTICLE_OUTLET_INDEX);
         }
      }

      private void AddConnectionForElectrostaticPrecipitatorParticleOutlet(ElectrostaticPrecipitatorControl uoCtrl)
      {
         if(uoCtrl.ElectrostaticPrecipitator.ParticleOutlet != null)
         {
            ProcessStreamBaseControl strCtrl = uoCtrl.Flowsheet.StreamManager.GetProcessStreamBaseControl(uoCtrl.ElectrostaticPrecipitator.ParticleOutlet.Name);
            strCtrl.Location = new Point(uoCtrl.Location.X + uoCtrl.Width, uoCtrl.Location.Y + uoCtrl.Height + UI.DELTA_H);
            uoCtrl.CreateConnection(uoCtrl.ElectrostaticPrecipitator, strCtrl.ProcessStreamBase, BagFilter.PARTICLE_OUTLET_INDEX);
         }
      }
      ...
      public static Point CalculateLeftStreamLocation(Control ctrlRight, Control ctrlLeft) {
      ...
      public static Point CalculateRightStreamLocation(Control ctrlLeft, Control ctrlRight) {
      ...
      public static Point CalculateRightStreamLocation(Control ctrlLeft, Control ctrlRight, int k, int n) {
      ...
      public static Point CalculateUpStreamLocation(Control ctrlDown, Control ctrlUp) {
      ...
      public static Point CalculateDownStreamLocation(Control ctrlUp, Control ctrlDown) {
      ...
      public bool HasUnitOpControls() {
         return this.HasUnitOpControls<UnitOpControl>();
      }
