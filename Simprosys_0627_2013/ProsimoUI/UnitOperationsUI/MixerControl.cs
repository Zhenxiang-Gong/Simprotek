...
namespace ProsimoUI.UnitOperationsUI {
   ...
   public class MixerControl : UnitOpControl {
      ...
      protected MixerControl(SerializationInfo info, StreamingContext context)
         : base(info, context) {
      }
      ...
      public override void SetObjectData() {
         base.SetObjectData();
         int persistedClassVersion = info.GetInt32("ClassPersistenceVersionMixerControl");
      }
