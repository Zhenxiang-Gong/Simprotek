...
namespace ProsimoUI.UnitOperationsUI
{
	...
	public class UnitOpEditor : SolvableEditor
	{
      ...
      public UnitOpEditor()
      {
		...
		public UnitOpEditor(UnitOpControl unitOpCtrl) : base(unitOpCtrl)
		{
			//
			// Required for Windows Form Designer support
			//
		...
		{
         System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(UnitOpEditor));
         // 
         // UnitOpEditor
         // 
