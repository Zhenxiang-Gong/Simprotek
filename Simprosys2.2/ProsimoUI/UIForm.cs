...
namespace ProsimoUI
{
   ...
   public class UIForm : Form
   {
      ...
      private ImageList imageListGasLeft;
      ...
      private System.ComponentModel.IContainer components;
		...
		private void InitializeComponent()
		{
         ...
         this.imageListBurner.Images.SetKeyName(2, "burner_ctrl_solve_failed.bmp");
         this.imageListBurner.Images.SetKeyName(3, "burner_ctrl_solved.bmp");
         // 
         // UIForm
         // 
