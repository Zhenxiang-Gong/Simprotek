...
namespace Prosimo.UnitSystems
{
   ...
   /// <summary>
	...
	/// </summary>
   public class VolumeRateFlowGasesUnit : EngineeringUnit {
      public static VolumeRateFlowGasesUnit Instance = new VolumeRateFlowGasesUnit();

      private VolumeRateFlowGasesUnit() {
