...
namespace Prosimo.UnitOperations.ProcessStreams {
   ...
   public abstract class ProcessStreamBase : Solvable {
      ...
      protected ProcessStreamBase(string name, MaterialComponents mComponents, UnitOperationSystem uoSys)
         : base(name, uoSys) {
      ...
      protected string BuildProperErrorMessage(string initMsg) {
         StringBuilder sb = new StringBuilder(initMsg);
         if (this.UpStreamOwner != null && this.downStreamOwner != null) {
            sb.Append(", ").Append(this.UpStreamOwner.Name).Append(" and ").Append(this.UpStreamOwner.Name);
         }
         else if (this.upStreamOwner != null) {
            sb.Append(" and ").Append(this.UpStreamOwner.Name);
         }
         else if (this.downStreamOwner != null) {
            sb.Append(" and ").Append(this.downStreamOwner.Name);
         }

         sb.Append(" is appropriate.");

         return sb.ToString();
      }

      protected ProcessStreamBase(SerializationInfo info, StreamingContext context)
         : base(info, context) {
      }
