...
namespace Prosimo.UnitOperations {
   ...
   /// <summary>
	...
	/// </summary>
	[Serializable]
	public abstract class UnitOperationSystem : Storable {
      ...
      internal void UnregisterProcessVar(ProcessVar var) {
      ...
      internal void UnregisterProcessVars(ArrayList varList) {
         foreach (ProcessVar var in varList) {
            procVarTable.Remove(var.ID);
         }
      }
