...
namespace ProsimoUI {
   ...
   public class MainForm : System.Windows.Forms.Form {
      ...
      private System.Windows.Forms.MenuItem menuItemFuelCatalog;
      ...
      private const string FUELCAT_XML = "fuelcat.xml";
      ...
      private void InitializeComponent() {
         ...
         this.menuItemFuelCatalog = new System.Windows.Forms.MenuItem();
         ...
         // menuItemFuelCatalog
         // 
         this.menuItemFuelCatalog.Index = 2;
         this.menuItemFuelCatalog.Text = "Drying Fuel Catalog";
         this.menuItemFuelCatalog.Click += new System.EventHandler(this.menuItemFossilFuelCatalog_Click);
         // 
      ...
      private void MainForm_Load(object sender, System.EventArgs e) {
         ...
         string fuelFileName = this.exePathName + MainForm.FUELCAT_XML;
         persistenceManager.UnpersistFossilFuelCatalog(fuelFileName);
      ...
      private void ClosingHandler(object sender, System.ComponentModel.CancelEventArgs e) {
         ...
         if (!this.Exit())
            ...
            string fuelFileName = this.exePathName + MainForm.FUELCAT_XML;
            persistenceManager.PersistFossilFuelCatalog(fuelFileName);
      ...
      private void menuItemFossilFuelCatalog_Click(object sender, System.EventArgs e) {
         FossilFuelCatalogForm form = new FossilFuelCatalogForm(this, this.ApplicationPrefs);
         form.ShowDialog(this);
      }
