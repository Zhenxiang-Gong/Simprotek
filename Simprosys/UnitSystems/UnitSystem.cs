...
namespace Prosimo.UnitSystems {
   ...
   public class UnitSystem : Storable
   {
      ...
      MoleFlowRateUnitType moleFlowRate;
      ...
      public UnitSystem Clone()
      {
         ...
         us.moleFlowRate = this.moleFlowRate;
      ...
      public MoleFlowRateUnitType MoleFlowRateUnitType {
         get { return moleFlowRate; }
         set { moleFlowRate = value; }
      }
      ...
      public override void GetObjectData(SerializationInfo info, StreamingContext context) {
         ...
         info.AddValue("VolumeHeatTransferCoefficientUnit", this.volumeHeatTransferCoefficient, typeof(VolumeHeatTransferCoefficientUnitType));
         ...
         //version 2
         info.AddValue("MoleFlowRateUnit", this.moleFlowRate, typeof(MoleFlowRateUnitType));
      }
   }
}
