...
namespace Prosimo.SubstanceLibrary {
   ...
   public class SubstanceCatalog {
      ...
      private IList<Substance> moistureSubstanceListForNitrogen;
      private IList<Substance> moistureSubstanceListForAir;
      ...
      private void CreateFuelSubstanceList()
      {
      ...
      private void CreateGenericFuelSubstanceList()
      {
      ...
      private void CreateGenericFoodSubstanceList()
      {
      ...
      private void CreateNitrogenMoistureSubstanceList()
      {
         moistureSubstanceListForNitrogen = new List<Substance>(); ;
      ...
      private void CreateAirMoistureSubstanceList()
      {
