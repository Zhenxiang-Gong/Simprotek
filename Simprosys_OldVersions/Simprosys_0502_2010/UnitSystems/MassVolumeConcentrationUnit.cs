...
namespace Prosimo.UnitSystems
{
   ...
   /// <summary>
	...
	/// </summary>
   public class MassVolumeConcentrationUnit : EngineeringUnit {
      public static MassVolumeConcentrationUnit Instance = new MassVolumeConcentrationUnit();

      private MassVolumeConcentrationUnit() {
