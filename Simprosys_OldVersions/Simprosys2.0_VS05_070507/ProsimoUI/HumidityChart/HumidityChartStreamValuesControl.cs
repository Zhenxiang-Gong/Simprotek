...
namespace ProsimoUI.HumidityChart
{
	...
	public class HumidityChartStreamValuesControl : System.Windows.Forms.UserControl
	{
      ...
      {
         this.textBoxTemperature.InitializeVariable(flowsheet.ApplicationPrefs, stream.Temperature);
         this.textBoxWetBulbTemperature.InitializeVariable(flowsheet.ApplicationPrefs, stream.WetBulbTemperature);
         this.textBoxDewPoint.InitializeVariable(flowsheet.ApplicationPrefs, stream.DewPoint);
         this.textBoxHumidity.InitializeVariable(flowsheet.ApplicationPrefs, stream.Humidity);
         this.textBoxRelativeHumidity.InitializeVariable(flowsheet.ApplicationPrefs, stream.RelativeHumidity);
         this.textBoxEnthalpy.InitializeVariable(flowsheet.ApplicationPrefs, stream.SpecificEnthalpy);
         this.textBoxSpecificHeatDryBase.InitializeVariable(flowsheet.ApplicationPrefs, stream.SpecificHeatDryBase);
         this.textBoxDensity.InitializeVariable(flowsheet.ApplicationPrefs, stream.Density);
      }
