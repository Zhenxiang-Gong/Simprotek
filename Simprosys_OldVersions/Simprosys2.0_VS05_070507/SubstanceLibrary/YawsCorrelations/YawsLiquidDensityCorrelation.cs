...
namespace Prosimo.SubstanceLibrary.YawsCorrelations {
   ...
   public class YawsLiquidDensityCorrelation : ThermalPropCorrelationBase {
      ...
      public YawsLiquidDensityCorrelation(string substanceName, double a, double b, double n, double tc, 
      ...
      public override void SetObjectData() {
         base.SetObjectData();
         int persistedClassVersion = info.GetInt32("ClassPersistenceVersionYawsLiquidDensityCorrelation");
      ...
      public override void GetObjectData(SerializationInfo info, StreamingContext context) {
         ...
         info.AddValue("ClassPersistenceVersionYawsLiquidDensityCorrelation", CLASS_PERSISTENCE_VERSION, typeof(int));
