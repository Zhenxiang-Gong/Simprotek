...
namespace ProsimoUI.ProcessStreamsUI
{
	...
	public class ProcessStreamValuesControl : System.Windows.Forms.UserControl
	{
      ...
      {
         this.textBoxMassFlowRate.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.ProcessStream.MassFlowRate);
         this.textBoxVolumeFlowRate.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.ProcessStream.VolumeFlowRate);
         this.textBoxPressure.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.ProcessStream.Pressure);
         this.textBoxTemperature.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.ProcessStream.Temperature);
         this.textBoxEnthalpy.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.ProcessStream.SpecificEnthalpy);
         this.textBoxSpecificHeat.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.ProcessStream.SpecificHeat);
         this.textBoxDensity.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.ProcessStream.Density);
      }
