...
namespace ProsimoUI {
   ...
   public class SelectSolvablesControl : System.Windows.Forms.UserControl {
      ...
      private void InitializeStreamList() {
         this.updateFlag = false;
         IList<ProcessStreamBaseControl> list = this.flowsheet.StreamManager.GetStreamControls<ProcessStreamBaseControl>();
         IEnumerator<ProcessStreamBaseControl> e = list.GetEnumerator();
         while (e.MoveNext()) {
