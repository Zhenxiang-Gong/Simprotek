...
namespace Prosimo.UnitOperations.ProcessStreams {
   ...
   public class MaterialComponents : Storable {
      ...
      /*public Phase MinorPhase {
         get { return (Phase)phases[phases.Count-1];}
         set { phases[phases.Count-1] = value;}
      }*/ 
      ...
      public override void SetObjectData() {
         ...
         if (persistedClassVersion == 1) {
            ...
            //this.phases = info.GetValue("Phases", typeof(ArrayList)) as ArrayList;
         }
      }
