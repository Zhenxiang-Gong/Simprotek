...
namespace Prosimo.UnitOperations.FluidTransport {
   ...
   public class Ejector : UnitOperation {
      ...
      public override bool CanAttachStream(ProcessStreamBase ps, int streamIndex) 
      {
         ...
         if (streamIndex == MOTIVE_INLET_INDEX && motiveInlet == null && ps.DownStreamOwner == null && (isLiquidMaterial || ps is WaterStream)) {
         ...
         else if (streamIndex == SUCTION_INLET_INDEX && suctionInlet == null && ps.DownStreamOwner == null && (isLiquidMaterial || ps is WaterStream)) {
            if (dischargeOutlet != null && dischargeOutlet.GetType() == ps.GetType()) {
               canAttach = true;
            }
         ...
         else if (streamIndex == DISCHARGE_OUTLET_INDEX && dischargeOutlet == null && ps.UpStreamOwner == null && (isLiquidMaterial || ps is WaterStream)) {
