...
namespace Prosimo.SubstanceLibrary.PerrysCorrelations {
   ...
   public class PerrysLiquidCpCorrelation : ThermalPropCorrelationBase {
      ...
      public PerrysLiquidCpCorrelation(string substanceName, double c1, double c2, double c3, double c4, 
      ...
      public override void SetObjectData() {
         base.SetObjectData();
         int persistedClassVersion = info.GetInt32("ClassPersistenceVersionPerrysLiquidCpCorrelation");
      ...
      public override void GetObjectData(SerializationInfo info, StreamingContext context) {
         ...
         info.AddValue("ClassPersistenceVersionPerrysLiquidCpCorrelation", CLASS_PERSISTENCE_VERSION, typeof(int));
