...
namespace Prosimo.SubstanceLibrary.PerrysCorrelations {
   ...
   public class PerrysVaporPressureCorrelation : ThermalPropCorrelationBase {
      ...
      public PerrysVaporPressureCorrelation(string substanceName, double c1, double c2, double c3, double c4, double c5,
      ...
      public override void SetObjectData() {
         base.SetObjectData();
         int persistedClassVersion = info.GetInt32("ClassPersistenceVersionPerrysVaporPressureCorrelation");
      ...
      public override void GetObjectData(SerializationInfo info, StreamingContext context) {
         ...
         info.AddValue("ClassPersistenceVersionPerrysVaporPressureCorrelation", CLASS_PERSISTENCE_VERSION, typeof(int));
