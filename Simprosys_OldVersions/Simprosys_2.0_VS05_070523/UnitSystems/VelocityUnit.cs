...
namespace Prosimo.UnitSystems
{
   ...
   /// <summary>
	...
	/// </summary>
   public class VelocityUnit : EngineeringUnit {
      public static VelocityUnit Instance = new VelocityUnit();
      ...
      public VelocityUnit() {
         ...
         coeffTable.Add(VelocityUnitType.KilometerPerHour, 1.0/3.6);    unitStringTable.Add(VelocityUnitType.KilometerPerHour, "km/h");
         ...
         coeffTable.Add(VelocityUnitType.InchPerHour, 7.05555556e-6);   unitStringTable.Add(VelocityUnitType.InchPerHour, "in/h");
         ...
         coeffTable.Add(VelocityUnitType.FootPerHour, 8.46666667E-5);   unitStringTable.Add(VelocityUnitType.FootPerHour, "ft/h");
         ...
         coeffTable.Add(VelocityUnitType.MilePerHour, 0.44704);         unitStringTable.Add(VelocityUnitType.MilePerHour, "mi/h");
