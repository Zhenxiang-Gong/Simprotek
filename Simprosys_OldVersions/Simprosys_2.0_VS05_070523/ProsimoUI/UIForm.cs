   ...
   public class UIForm : System.Windows.Forms.Form
   {
      ...
      private System.ComponentModel.IContainer components;
		...
		private void InitializeComponent()
		{
         ...
         this.imageListScrubberCondenser.Images.SetKeyName(0, "");
         this.imageListScrubberCondenser.Images.SetKeyName(1, "");
         this.imageListScrubberCondenser.Images.SetKeyName(2, "");
         this.imageListScrubberCondenser.Images.SetKeyName(3, "");
         // 
         // UIForm
         // 
