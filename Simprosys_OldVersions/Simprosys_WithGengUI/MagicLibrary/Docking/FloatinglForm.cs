...
{
	public class FloatingForm : System.Windows.Forms.Form, IHotZoneSource, IMessageFilter
	{
		// Class constants
      ...
      // DMD 08-08-05: check to see if any child controls are validating.
      protected virtual bool ContentsAreValidating
      {
         get
         {
            ContentCollection cc = ZoneHelper.Contents(_zone);
            foreach (Content c in cc)
               if (c != null && c.Control is IValidator)
               {
                  IValidator v = (IValidator)c.Control;
                  if (v.HandlingError)
                     return true;
               }
            return false;
        ...
        private void InitializeComponent()
        {
            ...
            // FloatingForm
            // 
            this.ClientSize = new System.Drawing.Size(115, 396);
            this.FormBorderStyle = System.Windows.Forms.FormBorderStyle.SizableToolWindow;
