         ...
         if (hotSideMassFlow.HasValue && coldSideMassFlow.HasValue) {
            ...
            // case 1.2--hot inlet temperature and cold outlet temperature are known
               ...
               if (!HasPhaseChangeHotSide() && !HasPhaseChangeColdSide()) {
                  ...
                  //      } while (Math.Abs(vfHotOut - vfHotOut_Old) > 1.0e-6 && counter < 500);
                  ...
                  //         tCold = tColdIn + c1;
                  //      } while (Math.Abs(tColdOut - tColdOut_Old) > 1.0e-6 && counter < 500);
                  ...
                  //      } while (Math.Abs(tHotOut - tHotOut_Old) > 1.0e-6 && counter < 500);
