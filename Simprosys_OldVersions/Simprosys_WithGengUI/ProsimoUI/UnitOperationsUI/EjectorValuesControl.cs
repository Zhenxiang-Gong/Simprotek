...
namespace ProsimoUI.UnitOperationsUI
{
   ...
   public class EjectorValuesControl : System.Windows.Forms.UserControl
   {
      ...
      {
         this.textBoxEntrainmentRatio.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.Ejector.EntrainmentRatio);
         this.textBoxCompressionRatio.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.Ejector.CompressionRatio);
         this.textBoxSuctionMotivePressureRatio.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.Ejector.SuctionMotivePressureRatio);
      }
