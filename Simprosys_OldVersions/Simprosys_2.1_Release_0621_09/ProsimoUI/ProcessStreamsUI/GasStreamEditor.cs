...
namespace ProsimoUI.ProcessStreamsUI {
   ...
   /// </summary>
   public class GasStreamEditor : SolvableEditor {
      ...
      public GasStreamEditor(GasStreamControl gasStreamCtrl)
         ...
         //ProcessVarLabelsControl gasLabelsCtrl = new ProcessVarLabelsControl(this.GasStreamCtrl.GasStream.VarList);
         ...
         //ProcessVarValuesControl gasValuesCtrl = new ProcessVarValuesControl(this.GasStreamCtrl.GasStream.VarList, this.GasStreamCtrl.Flowsheet.ApplicationPrefs);
