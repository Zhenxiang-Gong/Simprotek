...
namespace ProsimoUI.MaterialsUI
{
	...
	{
      private DMSubstancesControl dmComponentsControl;
...
//               this.labelHook.ForeColor = SystemColors.ControlText;
      ...
      public MaterialComponentNameAndFractionControl(DMSubstancesControl dmSubstancesCtrl, MaterialComponent matComponent, INumericFormat iNumericFormat)
      {
         // This call is required by the Windows.Forms Form Designer.
         InitializeComponent();
      ...
      private void InitializeTheUI(MaterialComponent materialComponent, INumericFormat iNumericFormat)
      {
