...
namespace Prosimo.ThermalPropExtractor {
   ...
   public enum ThermPropType { CriticalProp, GasCp, LiquidCp, SolidCp, EvapHeat, VapPressure, LiquidDensity, GasVisc, LiquidVisc, GasK, LiquidK, SurfaceTension, EnthalpyOfFormation };
