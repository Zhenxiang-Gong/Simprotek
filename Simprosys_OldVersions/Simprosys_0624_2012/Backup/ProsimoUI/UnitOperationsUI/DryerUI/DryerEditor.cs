...
namespace ProsimoUI.UnitOperationsUI.DryerUI {
   ...
   public class DryerEditor : UnitOpEditor {
      private const int INDEX_SCOPING = 1;
      ...
      //ProcessVarLabelsControl gasLabelsCtrl;
      //ProcessVarValuesControl gasValuesInCtrl;
      //ProcessVarValuesControl gasValuesOutCtrl;
      //ProcessVarLabelsControl materialLabelsCtrl;
      //ProcessVarValuesControl materialValuesInCtrl;
      //ProcessVarValuesControl materialValuesOutCtrl;
      ...
      public DryerEditor(DryerControl dryerCtrl)
         ...
         this.groupBoxDryer.Size = new System.Drawing.Size(280, 264);
         ...
         ProcessVarLabelsControl dryerLabelsCtrl = new ProcessVarLabelsControl(this.DryerCtrl.Dryer.VarList);
         ...
         ProcessVarValuesControl dryerValuesCtrl = new ProcessVarValuesControl(this.DryerCtrl);
