...
namespace Prosimo.SubstanceLibrary.YawsCorrelations {
   [Serializable]
   public class YawsLiquidSolidThermalConductivityCorrelation : ThermalPropCorrelationBase {
      private double a;
      private double b;
      private double c;

      public YawsLiquidSolidThermalConductivityCorrelation(string substanceName, string casRegestryNo, double a, double b, double c,
      ...
      protected YawsLiquidSolidThermalConductivityCorrelation(SerializationInfo info, StreamingContext context)
         : base(info, context) {
      }
