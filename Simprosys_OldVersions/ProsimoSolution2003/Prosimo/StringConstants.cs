...
namespace Prosimo {
   ...
   public abstract class StringConstants{
      ...
      public const string DEW_POINT = "DEW_POINT";
...
//      public const string COLD_SIDE_EXIT_NOZZLE_DIAMETER = "Cold Side Exit Nozzle Diameter";
      ...
      static StringConstants() 
      {
         ...
         varTypeNameTable.Add(DEW_POINT, "Dew Point");
         varTypeNameTable.Add(HUMIDITY, "Humidity");
         ...
         varTypeNameTable.Add(SPECIFIC_HEAT_ABS_DRY, "Specific Heat (dry mat)");
         ...
         varTypeNameTable.Add(LIQUID_RECIRCULATION_MASS_FLOW_RATE, "Liquid Recirculation Mass Flow Rate");
         varTypeNameTable.Add(LIQUID_RECIRCULATION_VOLUME_FLOW_RATE, "Liquid Recirculation Volume Flow Rate");
