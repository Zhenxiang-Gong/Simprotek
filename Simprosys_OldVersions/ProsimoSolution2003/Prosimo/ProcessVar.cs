...
namespace Prosimo {
   ...
   public abstract class ProcessVar : Storable {
      ...
      protected ProcessVar(string name, PhysicalQuantity type, VarState state) : base() {
         this.name = name;
         this.type = type;
         this.state = state;
      }
      ...
      protected ProcessVar(SerializationInfo info, StreamingContext context) : base (info, context) {
      }
   ...
   public class ProcessVarDouble : ProcessVar {
      ...
      protected ProcessVarDouble (SerializationInfo info, StreamingContext context) : base (info, context) {
      }
   ...
   public class ProcessVarInt : ProcessVar {
      ...
      protected ProcessVarInt (SerializationInfo info, StreamingContext context) : base (info, context) {
      }
