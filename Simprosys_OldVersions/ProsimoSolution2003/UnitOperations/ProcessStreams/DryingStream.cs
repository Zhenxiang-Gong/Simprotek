...
namespace Prosimo.UnitOperations.ProcessStreams {
   ...
   public abstract class DryingStream : ProcessStreamBase {
      ...
      protected DryingStream(string name, MaterialComponents mComponents, UnitOpSystem uoSys) : base(name, mComponents, uoSys) {
         ...
         specificHeatDryBase = new ProcessVarDouble(StringConstants.SPECIFIC_HEAT_DRY, PhysicalQuantity.SpecificHeat, VarState.Specified, this);
