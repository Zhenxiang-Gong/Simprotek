...
namespace Prosimo.UnitOperations.HeatTransfer {
   ...
   public abstract class HXRatingModel : Storable{
      ...
      public ErrorMessage SpecifyFlowDirection(FlowDirection aValue) {
         ...
         {   
            FlowDirection oldValue = flowDirection;
      ...
      {
         return flowDirection == FlowDirection.Parallel;
      }
      ...
      public double CalculateLmtd(double tHotIn, double tHotOut, double tColdIn, double tColdOut) {
         ...
         double deltaT1 = 0.0;
         double deltaT2 = 0.0;
         if (flowDirection == FlowDirection.Parallel) {
            deltaT1 = tHotIn - tColdIn;
            deltaT2 = tHotOut - tColdOut;
         }
         else if (flowDirection == FlowDirection.Counter) {
