...
namespace Prosimo.UnitOperations.HeatTransfer {
   ...
   public class HeatExchanger : UnitOperation {
      ...
      public HeatExchanger(string name, UnitOpSystem uoSys) : base(name, uoSys) {
...
//         }
      ...
      protected HeatExchanger(SerializationInfo info, StreamingContext context) : base(info, context) {
      }
