...
namespace Prosimo.UnitOperations.Drying {
   ...
   public class DryerRatingModelSimpleGeneric : DryerRatingModel {
      ...
      public DryerRatingModelSimpleGeneric(Dryer dryer) : base(dryer) 
      {
      ...
      protected DryerRatingModelSimpleGeneric (SerializationInfo info, StreamingContext context) : base(info, context) {
      }
