...
namespace Prosimo.UnitSystems
{
   ...
   public class FoulingFactorUnit {
      ...
      static FoulingFactorUnit() {
         ...
         coeffTable.Add(FoulingFactorUnitType.SquareMeterHourCelsiusPerKilocalory, 1.0/1.162222);  unitStringTable.Add(FoulingFactorUnitType.SquareMeterHourCelsiusPerKilocalory, "m2.hr.°C/kcal");
         ...
         coeffTable.Add(FoulingFactorUnitType.SquareCentimeterHourCelsiusPerCalory, 1.0/11.62222); unitStringTable.Add(FoulingFactorUnitType.SquareCentimeterHourCelsiusPerCalory, "cm2.hr.°C/cal");
         coeffTable.Add(FoulingFactorUnitType.SquareFootHourFahrenheitPerBtu, 1.0/5.678263);       unitStringTable.Add(FoulingFactorUnitType.SquareFootHourFahrenheitPerBtu, "ft2.hr.°F/Btu");
         ...
         coeffTable.Add(FoulingFactorUnitType.SquareFootHourRankinePerBtu, 1.0/5.678263);          unitStringTable.Add(FoulingFactorUnitType.SquareFootHourRankinePerBtu, "ft2.hr.°R/Btu");
      }
