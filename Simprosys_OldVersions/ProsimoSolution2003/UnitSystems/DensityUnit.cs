...
namespace Prosimo.UnitSystems
{
   ...
   public class DensityUnit {
      ...
      static DensityUnit() {
         ...
         coeffTable.Add(DensityUnitType.PoundPerCubicInch, 27679.9047);  unitStringTable.Add(DensityUnitType.PoundPerCubicInch, "Ibm/in3");
         coeffTable.Add(DensityUnitType.PoundPerCubicFoot, 16.0184634);  unitStringTable.Add(DensityUnitType.PoundPerCubicFoot, "Ibm/ft3");
         coeffTable.Add(DensityUnitType.PoundPerGallonUK, 99.7763288);   unitStringTable.Add(DensityUnitType.PoundPerGallonUK, "Ibm/UK gal");
         coeffTable.Add(DensityUnitType.PoundPerGallonUS, 119.826427);   unitStringTable.Add(DensityUnitType.PoundPerGallonUS, "Ibm/US gal");
