...
namespace Prosimo.UnitSystems
{
   ...
   public class MassVolumeConcentrationUnit {
      ...
      static MassVolumeConcentrationUnit() {
         ...
         coeffTable.Add(MassVolumeConcentrationUnitType.PoundPerKilogallonUS, 0.1198264);         unitStringTable.Add(MassVolumeConcentrationUnitType.PoundPerKilogallonUS, "Ibm/1000 US gal");
         coeffTable.Add(MassVolumeConcentrationUnitType.PoundPerKilogallonUK, 0.09977633);        unitStringTable.Add(MassVolumeConcentrationUnitType.PoundPerKilogallonUK, "Ibm/1000 UK gal");
         coeffTable.Add(MassVolumeConcentrationUnitType.PoundPerBbl, 2.853010177);                unitStringTable.Add(MassVolumeConcentrationUnitType.PoundPerBbl, "Ibm/bbl");
         coeffTable.Add(MassVolumeConcentrationUnitType.PoundPerKilobbl, 2.853010177e-3);         unitStringTable.Add(MassVolumeConcentrationUnitType.PoundPerKilobbl, "Ibm/1000 bbl");
