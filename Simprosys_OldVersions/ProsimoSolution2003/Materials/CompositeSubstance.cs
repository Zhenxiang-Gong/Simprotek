...
namespace Prosimo.Materials {
   ...
   public class CompositeSubstance : Substance {
      ...
      public CompositeSubstance(string name, ArrayList components) : base (name) {
      ...
      protected CompositeSubstance (SerializationInfo info, StreamingContext context) : base(info, context){
      }
