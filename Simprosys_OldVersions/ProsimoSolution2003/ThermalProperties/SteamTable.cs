...
namespace Prosimo.ThermalProperties
{
   ...
   public class SteamTable {
      ...
      public SubstanceStatesAndProperties GetPropertiesFromPressureAndTemperature (double pressure, double temperature) {
         temperature = TemperatureUnit.ConvertFromSIValue(TemperatureUnitType.Fahrenheit, temperature);
         pressure = PressureUnit.ConvertFromSIValue(PressureUnitType.IbfPerSquareInch, pressure);
         ...
         waterStatesAndProps.specificVolume = SpecificVolumeUnit.ConvertToSIValue(SpecificVolumeUnitType.CubicFootPerPound, specificVolume);
         waterStatesAndProps.density = DensityUnit.ConvertToSIValue(DensityUnitType.PoundPerCubicFoot, 1/specificVolume);
         waterStatesAndProps.enthalpy = SpecificEnergyUnit.ConvertToSIValue(SpecificEnergyUnitType.BtuPerPound, enthalpy);
         waterStatesAndProps.entropy = SpecificEntropyUnit.ConvertToSIValue(SpecificEntropyUnitType.BtuPerPoundFahrenheit, entropy);
         waterStatesAndProps.viscosity = DynamicViscosityUnit.ConvertToSIValue(DynamicViscosityUnitType.IbfSecPerSquareFoot, viscosity);
      ...
      public SubstanceStatesAndProperties GetPropertiesFromPressureAndVaporFraction (double pressure, double vaporFraction) {
         ...
         SubstanceStatesAndProperties waterStatesAndProps = new SubstanceStatesAndProperties();
         waterStatesAndProps.temperature = TemperatureUnit.ConvertToSIValue(TemperatureUnitType.Fahrenheit, temperature);
         //waterStatesAndProps.vaporFraction = quality/100;
         waterStatesAndProps.specificVolume = SpecificVolumeUnit.ConvertToSIValue(SpecificVolumeUnitType.CubicFootPerPound, specificVolume);
         waterStatesAndProps.density = DensityUnit.ConvertToSIValue(DensityUnitType.PoundPerCubicFoot, 1/specificVolume);
         waterStatesAndProps.enthalpy = SpecificEnergyUnit.ConvertToSIValue(SpecificEnergyUnitType.BtuPerPound, enthalpy);
      ...
      public SubstanceStatesAndProperties GetPropertiesFromTemperatureAndVaporFraction (double temperature, double vaporFraction) {
         ...
         SubstanceStatesAndProperties waterStatesAndProps = new SubstanceStatesAndProperties();
         waterStatesAndProps.pressure = PressureUnit.ConvertToSIValue(PressureUnitType.IbfPerSquareInch, pressure);
         //waterStatesAndProps.vaporFraction = quality/100;
         waterStatesAndProps.specificVolume = SpecificVolumeUnit.ConvertToSIValue(SpecificVolumeUnitType.CubicFootPerPound, specificVolume);
         waterStatesAndProps.density = DensityUnit.ConvertToSIValue(DensityUnitType.PoundPerCubicFoot, 1/specificVolume);
         waterStatesAndProps.enthalpy = SpecificEnergyUnit.ConvertToSIValue(SpecificEnergyUnitType.BtuPerPound, enthalpy);
      ...
      /*public SubstanceStatesAndProperties GetPropertiesFromPressureAndEnthalpy (double pressure, double enthalpy) {
         ...
         pressure = PressureUnit.ConvertFromSIValue(PressureUnitType.IbfPerSquareInch, pressure);
         enthalpy = SpecificEnergyUnit.ConvertFromSIValue(SpecificEnergyUnitType.BtuPerPound, enthalpy);
         ...
         double enthalpy = shvptx (pressure, temperature, quality, 2);
         double entropy = shvptx (pressure, temperature, quality, 1);
         double viscosity = vistv (temperature, 1.0/specifcVolume);
         
         SubstanceStatesAndProperties waterStatesAndProps = new SubstanceStatesAndProperties();
         waterStatesAndProps.temperature = temperature;
         waterStatesAndProps.vaporFraction = quality;
         waterStatesAndProps.specificVolume = specificVolum;
         waterStatesAndProps.density = 1/specificVolum;
         waterStatesAndProps.enthalpy = enthalpy;
         waterStatesAndProps.entropy = entropy;
         waterStatesAndProps.viscosity = viscosity;
         waterStatesAndProps.degreesOfSuperheat = 0;
         waterStatesAndProps.degreesOfSubcooling = 0;
      }*/
      ...
      public double GetEnthalpyFromPressureAndTemperature (double pressure, double temperature) {
         ...
         double quality = x_pt (pressure, temperature);
         double enthalpy = shvptx (pressure, temperature, quality, 2);
         return SpecificEnergyUnit.ConvertToSIValue(SpecificEnergyUnitType.BtuPerPound, enthalpy);
      }
      ...
      public double GetDensityFromPressureAndTemperature (double pressure, double temperature) {
         ...
         return DensityUnit.ConvertToSIValue(DensityUnitType.PoundPerCubicFoot, density);
      }
      ...
      public double GetSaturationTemperature (double pressure) {
         ...
         double psiValue = PressureUnit.ConvertFromSIValue(PressureUnitType.IbfPerSquareInch, pressure);
         double fahrenheitValue = tsl(psiValue);
         //return (fahrenheitValue + 459.67)/1.8;
         return TemperatureUnit.ConvertToSIValue(TemperatureUnitType.Fahrenheit, fahrenheitValue);
      } 
      ...
      public double GetSaturationPressure (double temperature) {
         ...
         double fahrenheitValue = TemperatureUnit.ConvertFromSIValue(TemperatureUnitType.Fahrenheit, temperature);
         double dpdt = 0;
         double psiValue = psl(fahrenheitValue, ref dpdt);
         //return psiValue * 6894.75729;
         return PressureUnit.ConvertToSIValue(PressureUnitType.IbfPerSquareInch, psiValue);
      } 
      ...
      public double GetViscosityFromPressureAndTemperature (double pressure, double temperature) {
         ...
         return DynamicViscosityUnit.ConvertToSIValue(DynamicViscosityUnitType.IbfSecPerSquareFoot, viscosity);
      }
