...
namespace ProsimoUI
{
   ...
   public delegate void PlotSelectedEventHandler(Plot2DGraph plotGraph);
	...
	public class UI
	{
      ...
      public const string UNIT_SYSTEMS = "unit_systems.xml";
      ...
      public Color FLOWSHEET_COLOR = Color.White;

      public const int SELECTION_SIZE = 3;
      public Color SELECTION_COLOR = Color.Gray;
      
      public Color CONNECTION_COLOR_GAS = Color.Violet;
      public Color CONNECTION_COLOR_MATERIAL = Color.Blue;
      public Color CONNECTION_COLOR_PROCESS = Color.Green;
      ...
      public Color COLOR_PARTIALLY_SOLVED = Color.Yellow;
