...
namespace ProsimoUI.MaterialsUI
{
	...
	/// </summary>
	public class MaterialComponentsControl : System.Windows.Forms.UserControl
	{
      ...
      public MaterialComponentsControl()
      {
		...
		private void InitializeComponent()
		{
         ...
         this.panel.Size = new System.Drawing.Size(258, 164);
         this.panel.TabIndex = 5;
         // 
         // MaterialComponentsControl
         // 
      ...
      public void UpdateTheUI(ArrayList materialComponentList)
      {
         ...
         while (e.MoveNext())
         {
            ...
            MaterialComponentNameAndFractionControl ctrl = new MaterialComponentNameAndFractionControl(this, mc);
      ...
      {
         this.UpdateTheUI(materialComponentList);
      }
   }
}
