...
namespace ProsimoUI.MaterialsUI
{
	...
	public class DryingMaterialsControl : System.Windows.Forms.UserControl
	{
      ...
      public const string STR_MAT_TYPE_INORGANIC = "Inorganic";
      ...
      private System.Windows.Forms.Label labelFilterByUserDef;
		...
		public DryingMaterialsControl()
		{
         ...
         this.comboBoxTypes.Items.Add(DryingMaterialsControl.STR_MAT_TYPE_INORGANIC);
      ...
      {
         MaterialType typeEnum = MaterialType.Unknown;
         if (typeStr.Equals(DryingMaterialsControl.STR_MAT_TYPE_GENERIC_FOOD))
            typeEnum = MaterialType.GenericFood;
         else if (typeStr.Equals(DryingMaterialsControl.STR_MAT_TYPE_INORGANIC))
            typeEnum = MaterialType.Inorganic;
      ...
      public static string GetDryingMaterialTypeAsString(MaterialType typeEnum)
      {
         ...
         else if (typeEnum == MaterialType.Inorganic)
            typeStr = DryingMaterialsControl.STR_MAT_TYPE_INORGANIC;
