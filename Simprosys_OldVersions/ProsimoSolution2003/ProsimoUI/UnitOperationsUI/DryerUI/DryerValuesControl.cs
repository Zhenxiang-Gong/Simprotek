...
namespace ProsimoUI.UnitOperationsUI.DryerUI
{
	...
	public class DryerValuesControl : System.Windows.Forms.UserControl
	{
      ...
      {
         this.textBoxMoistureEvaporationRate.InitializeVariable(ctrl.Flowsheet, ctrl.Dryer.MoistureEvaporationRate);
         this.textBoxSpecificHeatConsumption.InitializeVariable(ctrl.Flowsheet, ctrl.Dryer.SpecificHeatConsumption);
         this.textBoxThermalEfficiency.InitializeVariable(ctrl.Flowsheet, ctrl.Dryer.ThermalEfficiency);
         this.textBoxGasPressureDrop.InitializeVariable(ctrl.Flowsheet, ctrl.Dryer.GasPressureDrop);
         this.textBoxHeatLoss.InitializeVariable(ctrl.Flowsheet, ctrl.Dryer.HeatLoss);
         this.textBoxHeatInput.InitializeVariable(ctrl.Flowsheet, ctrl.Dryer.HeatInput);
         this.textBoxWorkInput.InitializeVariable(ctrl.Flowsheet, ctrl.Dryer.WorkInput);
         this.textBoxHeatLossByTransportDevice.InitializeVariable(ctrl.Flowsheet, ctrl.Dryer.HeatLossByTransportDevice);
         this.textFractionOfMaterialLostToGasOutlet.InitializeVariable(ctrl.Flowsheet, ctrl.Dryer.FractionOfMaterialLostToGasOutlet);
         this.textBoxGasOutletMaterialLoading.InitializeVariable(ctrl.Flowsheet, ctrl.Dryer.GasOutletMaterialLoading);
      }
