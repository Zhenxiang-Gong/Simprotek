...
namespace ProsimoUI.UnitOperationsUI.DryerUI
{
	...
	public class DryerScopingRectangularValuesControl : System.Windows.Forms.UserControl
	{
      ...
      {
         this.textBoxWidth.InitializeVariable(flowsheet, scoping.Width);
         this.textBoxLength.InitializeVariable(flowsheet, scoping.Length);
         this.textBoxHeight.InitializeVariable(flowsheet, scoping.Height);
         this.textBoxLengthWidthRatio.InitializeVariable(flowsheet, scoping.LengthWidthRatio);
         this.textBoxHeightWidthRatio.InitializeVariable(flowsheet, scoping.HeightWidthRatio);
      }
