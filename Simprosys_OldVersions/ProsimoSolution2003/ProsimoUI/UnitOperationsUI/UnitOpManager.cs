...
namespace ProsimoUI.UnitOperationsUI
{
	...
	public class UnitOpManager
	{
      ...
      public bool HasDryerControls
      {
         get
         {
            if (this.GetDryerControls().Count > 0)
               return true;
            else
               return false;
         }
      ...
      public bool HasHeatExchangerControls
      {
         get
         {
            if (this.GetHeatExchangerControls().Count > 0)
               return true;
            else
               return false;
         }
      ...
      public bool HasCycloneControls
      {
         get
         {
            if (this.GetCycloneControls().Count > 0)
               return true;
            else
               return false;
         }
      ...
      public bool HasEjectorControls
      {
         get
         {
            if (this.GetEjectorControls().Count > 0)
               return true;
            else
               return false;
         }
      ...
      public bool HasWetScrubberControls
      {
         get
         {
            if (this.GetWetScrubberControls().Count > 0)
               return true;
            else
               return false;
         }
      ...
      public bool HasMixerControls
      {
         get
         {
            if (this.GetMixerControls().Count > 0)
               return true;
            else
               return false;
         }
      ...
      public bool HasTeeControls
      {
         get
         {
            if (this.GetTeeControls().Count > 0)
               return true;
            else
               return false;
         }
      ...
      public bool HasFlashTankControls
      {
         get
         {
            if (this.GetFlashTankControls().Count > 0)
               return true;
            else
               return false;
         }
      ...
      public bool HasFanControls
      {
         get
         {
            if (this.GetFanControls().Count > 0)
               return true;
            else
               return false;
         }
      ...
      public bool HasValveControls
      {
         get
         {
            if (this.GetValveControls().Count > 0)
               return true;
            else
               return false;
         }
      ...
      public bool HasBagFilterControls
      {
         get
         {
            if (this.GetBagFilterControls().Count > 0)
               return true;
            else
               return false;
         }
      ...
      public bool HasAirFilterControls
      {
         get
         {
            if (this.GetAirFilterControls().Count > 0)
               return true;
            else
               return false;
         }
      ...
      public bool HasCompressorControls
      {
         get
         {
            if (this.GetCompressorControls().Count > 0)
               return true;
            else
               return false;
         }
      ...
      public bool HasHeaterControls
      {
         get
         {
            if (this.GetHeaterControls().Count > 0)
               return true;
            else
               return false;
         }
      ...
      public bool HasCoolerControls
      {
         get
         {
            if (this.GetCoolerControls().Count > 0)
               return true;
            else
               return false;
         }
      ...
      public bool HasElectrostaticPrecipitatorControls
      {
         get
         {
            if (this.GetElectrostaticPrecipitatorControls().Count > 0)
               return true;
            else
               return false;
         }
      ...
      public bool HasPumpControls
      {
         get
         {
            if (this.GetPumpControls().Count > 0)
               return true;
            else
               return false;
         }
      ...
      public bool HasRecycleControls
      {
         get
         {
            if (this.GetRecycleControls().Count > 0)
               return true;
            else
               return false;
         }
      ...
      public IList GetUnitOpControls()
      {
      ...
      public IList GetHeatExchangerControls()
      {
         IList ctrls = new ArrayList();
         IEnumerator e = this.flowsheet.Controls.GetEnumerator();
         while (e.MoveNext()) 
      ...
      public IList GetCycloneControls()
      {
         IList ctrls = new ArrayList();
         IEnumerator e = this.flowsheet.Controls.GetEnumerator();
         while (e.MoveNext()) 
      ...
      public IList GetEjectorControls()
      {
         IList ctrls = new ArrayList();
         IEnumerator e = this.flowsheet.Controls.GetEnumerator();
         while (e.MoveNext()) 
      ...
      public IList GetWetScrubberControls()
      {
         IList ctrls = new ArrayList();
         IEnumerator e = this.flowsheet.Controls.GetEnumerator();
         while (e.MoveNext()) 
      ...
      public IList GetMixerControls()
      {
         IList ctrls = new ArrayList();
         IEnumerator e = this.flowsheet.Controls.GetEnumerator();
         while (e.MoveNext()) 
         {
            if (e.Current is MixerControl)
            {
               ctrls.Add(e.Current);
            }
         }
      ...
      public IList GetTeeControls()
      {
         IList ctrls = new ArrayList();
         IEnumerator e = this.flowsheet.Controls.GetEnumerator();
         while (e.MoveNext()) 
         {
            if (e.Current is TeeControl)
            {
               ctrls.Add(e.Current);
            }
         }
      ...
      public IList GetFlashTankControls()
      {
         IList ctrls = new ArrayList();
         IEnumerator e = this.flowsheet.Controls.GetEnumerator();
         while (e.MoveNext()) 
         {
            if (e.Current is FlashTankControl)
            {
               ctrls.Add(e.Current);
            }
         }
      ...
      public IList GetBagFilterControls()
      {
         IList ctrls = new ArrayList();
         IEnumerator e = this.flowsheet.Controls.GetEnumerator();
         while (e.MoveNext()) 
      ...
      public IList GetAirFilterControls()
      {
         IList ctrls = new ArrayList();
         IEnumerator e = this.flowsheet.Controls.GetEnumerator();
         while (e.MoveNext()) 
      ...
      public IList GetCompressorControls()
      {
         IList ctrls = new ArrayList();
         IEnumerator e = this.flowsheet.Controls.GetEnumerator();
         while (e.MoveNext()) 
      ...
      public IList GetHeaterControls()
      {
         IList ctrls = new ArrayList();
         IEnumerator e = this.flowsheet.Controls.GetEnumerator();
         while (e.MoveNext()) 
      ...
      public IList GetCoolerControls()
      {
         IList ctrls = new ArrayList();
         IEnumerator e = this.flowsheet.Controls.GetEnumerator();
         while (e.MoveNext()) 
      ...
      public IList GetElectrostaticPrecipitatorControls()
      {
         IList ctrls = new ArrayList();
         IEnumerator e = this.flowsheet.Controls.GetEnumerator();
         while (e.MoveNext()) 
      ...
      public IList GetRecycleControls()
      {
         IList ctrls = new ArrayList();
         IEnumerator e = this.flowsheet.Controls.GetEnumerator();
         while (e.MoveNext()) 
         {
            if (e.Current is RecycleControl)
            {
               ctrls.Add(e.Current);
            }
         }
