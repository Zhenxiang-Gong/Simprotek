...
//               this.labelHook.ForeColor = SystemColors.ControlText;
      ...
      {
         this.textBoxDiameter.InitializeVariable(flowsheet, sizeAndFraction.Diameter);
         this.textBoxWeightFraction.InitializeVariable(flowsheet, sizeAndFraction.WeightFraction);
         this.textBoxEfficiency.InitializeVariable(flowsheet, sizeAndFraction.Efficiency);
      }
