...
namespace ProsimoUI.UnitOperationsUI.HeatExchangerUI
{
	...
	public class HeatExchangerValuesControl : System.Windows.Forms.UserControl
	{
      ...
      {
         this.textBoxTotalHeatTransfer.InitializeVariable(ctrl.Flowsheet, ctrl.HeatExchanger.TotalHeatTransfer);
         this.textBoxColdSidePressureDrop.InitializeVariable(ctrl.Flowsheet, ctrl.HeatExchanger.ColdSidePressureDrop);
         this.textBoxHotSidePressureDrop.InitializeVariable(ctrl.Flowsheet, ctrl.HeatExchanger.HotSidePressureDrop);
      }
