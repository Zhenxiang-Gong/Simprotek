   ...
   public class HeatExchangerControl : UnitOpControl
	{
      ...
      protected override void UpdateBackImage()
      {
         ...
         {
            this.BackgroundImage = UI.IMAGES.HEATEXCHANGER_CTRL_PARTIALLY_SOLVED_IMG;
         }
      ...
      private string ToPrintSimpleGenericRating()
      {
         ...
         if (ratingModel.FlowDirection == FlowDirection.Counter)
            flowDirectionStr = "Counter";
         else if (ratingModel.FlowDirection == FlowDirection.Cross)
            flowDirectionStr = "Cross";
         else if (ratingModel.FlowDirection == FlowDirection.Parallel)
