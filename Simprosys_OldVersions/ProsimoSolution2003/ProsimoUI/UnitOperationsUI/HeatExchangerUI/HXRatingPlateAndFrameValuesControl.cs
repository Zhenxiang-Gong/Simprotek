...
namespace ProsimoUI.UnitOperationsUI.HeatExchangerUI
{
	...
	public class HXRatingPlateAndFrameValuesControl : System.Windows.Forms.UserControl
	{
      ...
      {
         this.textBoxProjectedPlateArea.InitializeVariable(flowsheet, rating.ProjectedPlateArea);
         this.textBoxActualEffectivePlateArea.InitializeVariable(flowsheet, rating.ActualEffectivePlateArea);
         this.textBoxPlatePitch.InitializeVariable(flowsheet, rating.PlatePitch);
         this.textBoxColdSidePasses.InitializeVariable(flowsheet, rating.ColdSidePasses);
         this.textBoxCompressedPlatePakcLength.InitializeVariable(flowsheet, rating.CompressedPlatePackLength);
         this.textBoxVerticalPortDistance.InitializeVariable(flowsheet, rating.VerticalPortDistance);
         this.textBoxHorizontalPortDistance.InitializeVariable(flowsheet, rating.HorizontalPortDistance);
         this.textBoxPortDiameter.InitializeVariable(flowsheet, rating.PortDiameter);
         this.textBoxHotSidePasses.InitializeVariable(flowsheet, rating.HotSidePasses);
         this.textBoxNumberOfPlates.InitializeVariable(flowsheet, rating.NumberOfPlates);
         this.textBoxEnlargementFactor.InitializeVariable(flowsheet, rating.EnlargementFactor);
         this.textBoxProjectedChannelLength.InitializeVariable(flowsheet, rating.ProjectedChannelLength);
         this.textBoxChannelWidth.InitializeVariable(flowsheet, rating.ChannelWidth);
         this.textBoxPlateWallThickness.InitializeVariable(flowsheet, rating.PlateWallThickness);
      }
