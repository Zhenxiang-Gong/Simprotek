...
namespace ProsimoUI.UnitOperationsUI
{
   ...
   public class WetScrubberControl : UnitOpControl
   {
      ...
      protected override void UpdateBackImage()
      {
         ...
         {
            this.BackgroundImage = UI.IMAGES.WETSCRUBBER_CTRL_PARTIALLY_SOLVED_IMG;
         }
      ...
      public override string ToPrint()
      {
         ...
         sb.Append("Scrubber Type");
         sb.Append(" = ");
         string scrubberTypeStr = "";
         if (this.WetScrubber.ScrubberType == ScrubberType.Condensing)
            scrubberTypeStr = "Condensing";
         else if (this.WetScrubber.ScrubberType == ScrubberType.General)
            scrubberTypeStr = "General";
         sb.Append("Scrubber Type");
         sb.Append(" = ");
         sb.Append(scrubberTypeStr);
         sb.Append("\r\n");
