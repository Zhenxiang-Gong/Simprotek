   ...
   public class FlashTankControl : UnitOpControl
	{
      ...
      protected override void UpdateBackImage()
      {
         ...
         {
            this.BackgroundImage = UI.IMAGES.FLASHTANK_CTRL_PARTIALLY_SOLVED_IMG;
         }
      ...
      protected FlashTankControl(SerializationInfo info, StreamingContext context) : base(info, context)
      {
      }
