...
{
	/// <summary>
	/// Summary description for CoolerValuesControl.
	/// </summary>
	public class CoolerValuesControl : System.Windows.Forms.UserControl
	{
      ...
      {
         this.textBoxPressureDrop.InitializeVariable(ctrl.Flowsheet, ctrl.Cooler.PressureDrop);
         this.textBoxHeatLoss.InitializeVariable(ctrl.Flowsheet, ctrl.Cooler.HeatLoss);
         this.textBoxHeatInput.InitializeVariable(ctrl.Flowsheet, ctrl.Cooler.HeatInput);
      }
