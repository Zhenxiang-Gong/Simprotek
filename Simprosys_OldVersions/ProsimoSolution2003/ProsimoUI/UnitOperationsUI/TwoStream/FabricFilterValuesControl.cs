...
namespace ProsimoUI.UnitOperationsUI.TwoStream
{
	...
	public class FabricFilterValuesControl : System.Windows.Forms.UserControl
	{
      ...
      {
         this.textBoxPressureDrop.InitializeVariable(ctrl.Flowsheet, ctrl.FabricFilter.GasPressureDrop);
         this.textBoxCollectionEfficiency.InitializeVariable(ctrl.Flowsheet, ctrl.FabricFilter.CollectionEfficiency);
         this.textBoxInletParticleLoading.InitializeVariable(ctrl.Flowsheet, ctrl.FabricFilter.InletParticleLoading);
         this.textBoxOutletParticleLoading.InitializeVariable(ctrl.Flowsheet, ctrl.FabricFilter.OutletParticleLoading);
         this.textBoxParticleCollectionRate.InitializeVariable(ctrl.Flowsheet, ctrl.FabricFilter.ParticleCollectionRate);
         this.textBoxMassFlowRateOfParticleLostToGasOutlet.InitializeVariable(ctrl.Flowsheet, ctrl.FabricFilter.MassFlowRateOfParticleLostToGasOutlet);
         this.textBoxGasToClothRatio.InitializeVariable(ctrl.Flowsheet, ctrl.FabricFilter.GasToClothRatio);
         this.textBoxTotalFilteringArea.InitializeVariable(ctrl.Flowsheet, ctrl.FabricFilter.TotalFilteringArea);
      }
