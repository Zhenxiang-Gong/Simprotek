...
namespace ProsimoUI.UnitOperationsUI.TwoStream
{
	...
	public class CompressorValuesControl : System.Windows.Forms.UserControl
	{
      ...
      public const int INDEX_POLYTROPIC = 1;
      public const int INDEX_ADIABATIC = 2;
      ...
      {
         this.textBoxPressureRatio.InitializeVariable(ctrl.Flowsheet, ctrl.Compressor.OutletInletPressureRatio);
         this.textBoxAdiabaticExponent.InitializeVariable(ctrl.Flowsheet, ctrl.Compressor.AdiabaticExponent);
         this.textBoxAdiabaticEfficiency.InitializeVariable(ctrl.Flowsheet, ctrl.Compressor.AdiabaticEfficiency);
         this.textBoxPolytropicExponent.InitializeVariable(ctrl.Flowsheet, ctrl.Compressor.PolytropicExponent);
         this.textBoxPolytropicEfficiency.InitializeVariable(ctrl.Flowsheet, ctrl.Compressor.PolytropicEfficiency);
         this.textBoxPowerInput.InitializeVariable(ctrl.Flowsheet, ctrl.Compressor.PowerInput);
      }
