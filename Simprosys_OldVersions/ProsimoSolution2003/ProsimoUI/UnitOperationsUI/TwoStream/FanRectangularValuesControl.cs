...
namespace ProsimoUI.UnitOperationsUI.TwoStream
{
	...
	public class FanRectangularValuesControl : System.Windows.Forms.UserControl
	{
      ...
      {
         this.textBoxOutletWidth.InitializeVariable(ctrl.Flowsheet, ctrl.Fan.OutletWidth);
         this.textBoxOutletHeight.InitializeVariable(ctrl.Flowsheet, ctrl.Fan.OutletHeight);
         this.textBoxOutletHeightWidthRatio.InitializeVariable(ctrl.Flowsheet, ctrl.Fan.OutletHeightWidthRatio);
      }
