...
namespace ProsimoUI.UnitOperationsUI.TwoStream
{
	...
	public class PumpDimensionsControl : System.Windows.Forms.UserControl
	{
      ...
      {
         this.textBoxOutletDiameter.InitializeVariable(ctrl.Flowsheet, ctrl.Pump.OutletDiameter);
         this.textBoxOutletVelocity.InitializeVariable(ctrl.Flowsheet, ctrl.Pump.OutletVelocity);
      }
