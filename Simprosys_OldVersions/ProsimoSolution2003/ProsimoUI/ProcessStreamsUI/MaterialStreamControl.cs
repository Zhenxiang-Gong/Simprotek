   ...
   public class MaterialStreamControl : DryingStreamControl
	{
      ...
      protected override void UpdateBackImage()
      {
         if (this.MaterialStream.MaterialStateType == MaterialStateType.Solid)
         {
            if (this.Orientation.Equals(StreamOrientation.Down))
            {
               ...
               {
                  this.BackgroundImage = UI.IMAGES.MATERIAL_SOLID_CTRL_PARTIALLY_SOLVED_DOWN_IMG;
               }
            ...
            else if (this.Orientation.Equals(StreamOrientation.Left))
            {
               ...
               {
                  this.BackgroundImage = UI.IMAGES.MATERIAL_SOLID_CTRL_PARTIALLY_SOLVED_LEFT_IMG;
               }
               else if (this.Solvable.SolveState.Equals(SolveState.Solved))
               {
            ...
            else if (this.Orientation.Equals(StreamOrientation.Right))
            {
               ...
               {
                  this.BackgroundImage = UI.IMAGES.MATERIAL_SOLID_CTRL_PARTIALLY_SOLVED_RIGHT_IMG;
               }
               else if (this.Solvable.SolveState.Equals(SolveState.Solved))
               {
            ...
            else if (this.Orientation.Equals(StreamOrientation.Up))
            {
               ...
               {
                  this.BackgroundImage = UI.IMAGES.MATERIAL_SOLID_CTRL_PARTIALLY_SOLVED_UP_IMG;
               }
               else if (this.Solvable.SolveState.Equals(SolveState.Solved))
               {
         ...
         else if (this.MaterialStream.MaterialStateType == MaterialStateType.Liquid)
         {
            if (this.Orientation.Equals(StreamOrientation.Down))
            {
               ...
               {
                  this.BackgroundImage = UI.IMAGES.MATERIAL_LIQUID_CTRL_PARTIALLY_SOLVED_DOWN_IMG;
               }
               else if (this.Solvable.SolveState.Equals(SolveState.Solved))
               {
            ...
            else if (this.Orientation.Equals(StreamOrientation.Left))
            {
               ...
               {
                  this.BackgroundImage = UI.IMAGES.MATERIAL_LIQUID_CTRL_PARTIALLY_SOLVED_LEFT_IMG;
               }
               else if (this.Solvable.SolveState.Equals(SolveState.Solved))
               {
            ...
            else if (this.Orientation.Equals(StreamOrientation.Right))
            {
               ...
               {
                  this.BackgroundImage = UI.IMAGES.MATERIAL_LIQUID_CTRL_PARTIALLY_SOLVED_RIGHT_IMG;
               }
               else if (this.Solvable.SolveState.Equals(SolveState.Solved))
               {
            ...
            else if (this.Orientation.Equals(StreamOrientation.Up))
            {
               ...
               {
                  this.BackgroundImage = UI.IMAGES.MATERIAL_LIQUID_CTRL_PARTIALLY_SOLVED_UP_IMG;
               }
               else if (this.Solvable.SolveState.Equals(SolveState.Solved))
               {
      ...
      public override string ToPrint()
      {
         ...
         sb.Append(UI.GetVariableName(this.MaterialStream.SpecificHeatAbsDry, us));
         sb.Append(" = ");
         sb.Append(UI.GetVariableValue(this.MaterialStream.SpecificHeatAbsDry, us, nfs));
         sb.Append("\r\n");
