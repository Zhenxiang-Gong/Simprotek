...
namespace ProsimoUI.ProcessStreamsUI
{
	...
	public class MaterialStreamValuesControl : System.Windows.Forms.UserControl
	{
      ...
      private ProsimoUI.ProcessVarTextBox textBoxSpecificHeatAbsDry;
      ...
      public MaterialStreamValuesControl()
      {
		...
		private void InitializeComponent()
		{
         ...
         this.textBoxSpecificHeatAbsDry = new ProsimoUI.ProcessVarTextBox();
         ...
         // 
         // textBoxSpecificHeatAbsDry
         // 
         this.textBoxSpecificHeatAbsDry.Location = new System.Drawing.Point(0, 220);
         this.textBoxSpecificHeatAbsDry.Name = "textBoxSpecificHeatAbsDry";
         this.textBoxSpecificHeatAbsDry.Size = new System.Drawing.Size(80, 20);
         this.textBoxSpecificHeatAbsDry.TabIndex = 11;
         this.textBoxSpecificHeatAbsDry.Text = "";
         this.textBoxSpecificHeatAbsDry.KeyUp += new System.Windows.Forms.KeyEventHandler(this.KeyUpHandler);
         // 
         ...
         this.Controls.Add(this.textBoxSpecificHeatAbsDry);
      ...
      {
         this.textBoxMassFlowRateDryBase.InitializeVariable(ctrl.Flowsheet, ctrl.MaterialStream.MassFlowRateDryBase);
         this.textBoxMassFlowRate.InitializeVariable(ctrl.Flowsheet, ctrl.MaterialStream.MassFlowRate);
         this.textBoxVolumeFlowRate.InitializeVariable(ctrl.Flowsheet, ctrl.MaterialStream.VolumeFlowRate);
         this.textBoxPressure.InitializeVariable(ctrl.Flowsheet, ctrl.MaterialStream.Pressure);
         this.textBoxTemperature.InitializeVariable(ctrl.Flowsheet, ctrl.MaterialStream.Temperature);
         this.textBoxMoistureContentDryBase.InitializeVariable(ctrl.Flowsheet, ctrl.MaterialStream.MoistureContentDryBase);
         this.textBoxMoistureContentWetBase.InitializeVariable(ctrl.Flowsheet, ctrl.MaterialStream.MoistureContentWetBase);
         this.textBoxConcentration.InitializeVariable(ctrl.Flowsheet, ctrl.MaterialStream.MassConcentration);
         this.textBoxSpecificHeat.InitializeVariable(ctrl.Flowsheet, ctrl.MaterialStream.SpecificHeat);
         this.textBoxSpecificHeatAbsDry.InitializeVariable(ctrl.Flowsheet, ctrl.MaterialStream.SpecificHeatAbsDry);
         this.textBoxDensity.InitializeVariable(ctrl.Flowsheet, ctrl.MaterialStream.Density);
         this.textBoxSpecificEnthalpy.InitializeVariable(ctrl.Flowsheet, ctrl.MaterialStream.SpecificEnthalpy);
         this.textBoxVaporFraction.InitializeVariable(ctrl.Flowsheet, ctrl.MaterialStream.VaporFraction);
      }
      ...
      private void KeyUpHandler(object sender, System.Windows.Forms.KeyEventArgs e)
      {
         ...
         if (!isLiquid)
            list.Add(this.textBoxSpecificHeatAbsDry);
