...
namespace ProsimoUI.ProcessStreamsUI
{
	...
	public class MaterialStreamLabelsControl : System.Windows.Forms.UserControl
	{
      ...
      private ProsimoUI.ProcessVarLabel labelSpecificHeatAbsDry;
      /// <summary> 
      ...
      public MaterialStreamLabelsControl()
      {
		...
		private void InitializeComponent()
		{
         ...
         this.labelSpecificHeatAbsDry = new ProsimoUI.ProcessVarLabel();
         this.SuspendLayout();
         // 
         ...
         // 
         // labelSpecificHeatAbsDry
         // 
         this.labelSpecificHeatAbsDry.BorderStyle = System.Windows.Forms.BorderStyle.Fixed3D;
         this.labelSpecificHeatAbsDry.Location = new System.Drawing.Point(0, 220);
         this.labelSpecificHeatAbsDry.Name = "labelSpecificHeatAbsDry";
         this.labelSpecificHeatAbsDry.Size = new System.Drawing.Size(192, 20);
         this.labelSpecificHeatAbsDry.TabIndex = 116;
         this.labelSpecificHeatAbsDry.Text = "SpecificHeatAbsDry";
         this.labelSpecificHeatAbsDry.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
         // 
         // labelConcentration
         // 
         ...
         this.Controls.Add(this.labelSpecificHeatAbsDry);
      ...
      public void InitializeVariableLabels(DryingMaterialStream stream)
      {
         ...
         this.labelSpecificHeatAbsDry.InitializeVariable(stream.SpecificHeatAbsDry);
