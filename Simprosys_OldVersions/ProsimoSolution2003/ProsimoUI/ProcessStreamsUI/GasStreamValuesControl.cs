...
namespace ProsimoUI.ProcessStreamsUI
{
	...
	public class GasStreamValuesControl : System.Windows.Forms.UserControl
	{
      ...
      {
         this.textBoxMassFlowRateDry.InitializeVariable(ctrl.Flowsheet, ctrl.GasStream.MassFlowRateDryBase);
         this.textBoxMassFlowRate.InitializeVariable(ctrl.Flowsheet, ctrl.GasStream.MassFlowRate);
         this.textBoxVolumeFlowRate.InitializeVariable(ctrl.Flowsheet, ctrl.GasStream.VolumeFlowRate);
         this.textBoxPressure.InitializeVariable(ctrl.Flowsheet, ctrl.GasStream.Pressure);
         this.textBoxTemperature.InitializeVariable(ctrl.Flowsheet, ctrl.GasStream.Temperature);
         this.textBoxWetBulbTemperature.InitializeVariable(ctrl.Flowsheet, ctrl.GasStream.WetBulbTemperature);
         this.textBoxDewPoint.InitializeVariable(ctrl.Flowsheet, ctrl.GasStream.DewPoint);
         this.textBoxHumidity.InitializeVariable(ctrl.Flowsheet, ctrl.GasStream.Humidity);
         this.textBoxRelativeHumidity.InitializeVariable(ctrl.Flowsheet, ctrl.GasStream.RelativeHumidity);
         this.textBoxEnthalpy.InitializeVariable(ctrl.Flowsheet, ctrl.GasStream.SpecificEnthalpy);
         this.textBoxSpecificHeatDryBase.InitializeVariable(ctrl.Flowsheet, ctrl.GasStream.SpecificHeatDryBase);
         this.textBoxDensity.InitializeVariable(ctrl.Flowsheet, ctrl.GasStream.Density);
      }
