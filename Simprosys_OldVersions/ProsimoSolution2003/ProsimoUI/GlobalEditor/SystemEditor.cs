...
namespace ProsimoUI.GlobalEditor
{
	...
	{
      private const string EVAPORATION_DRYING_SYSTEM = "Evaporation and Drying System: ";
      ...
      private System.Windows.Forms.MenuItem menuItemName;
		...
		public SystemEditor(Flowsheet flowsheet)
		{
         ...
         this.Text = SystemEditor.EVAPORATION_DRYING_SYSTEM + this.flowsheet.EvaporationAndDryingSystem.Name;
		...
		{
         System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(SystemEditor));
      ...
      private void PrepareToPrint()
      {
         ...
         sb.Append(this.flowsheet.EvaporationAndDryingSystem.Name);
         sb.Append("\r\n");
         sb.Append(UI.UNDERLINE2);
         sb.Append("\r\n");
         sb.Append("\r\n");

         IList list = this.flowsheet.StreamManager.GetShowableInEditorGasStreamControls();
         this.AddListToStringBuilder(list, sb);

         list = this.flowsheet.StreamManager.GetShowableInEditorMaterialStreamControls();
         this.AddListToStringBuilder(list, sb);

         list = this.flowsheet.UnitOpManager.GetShowableInEditorAirFilterControls();
         this.AddListToStringBuilder(list, sb);

         list = this.flowsheet.UnitOpManager.GetShowableInEditorBagFilterControls();
         this.AddListToStringBuilder(list, sb);

         list = this.flowsheet.UnitOpManager.GetShowableInEditorCompressorControls();
         this.AddListToStringBuilder(list, sb);

         list = this.flowsheet.UnitOpManager.GetShowableInEditorCoolerControls();
         this.AddListToStringBuilder(list, sb);

         list = this.flowsheet.UnitOpManager.GetShowableInEditorElectrostaticPrecipitatorControls();
         this.AddListToStringBuilder(list, sb);

         list = this.flowsheet.UnitOpManager.GetShowableInEditorCycloneControls();
         this.AddListToStringBuilder(list, sb);

         list = this.flowsheet.UnitOpManager.GetShowableInEditorEjectorControls();
         this.AddListToStringBuilder(list, sb);

         list = this.flowsheet.UnitOpManager.GetShowableInEditorWetScrubberControls();
         this.AddListToStringBuilder(list, sb);

         list = this.flowsheet.UnitOpManager.GetShowableInEditorDryerControls();
         this.AddListToStringBuilder(list, sb);

         list = this.flowsheet.UnitOpManager.GetShowableInEditorHeaterControls();
         this.AddListToStringBuilder(list, sb);

         list = this.flowsheet.UnitOpManager.GetShowableInEditorFanControls();
         this.AddListToStringBuilder(list, sb);

         list = this.flowsheet.UnitOpManager.GetShowableInEditorPumpControls();
         this.AddListToStringBuilder(list, sb);
         
         list = this.flowsheet.UnitOpManager.GetShowableInEditorValveControls();
         this.AddListToStringBuilder(list, sb);
      ...
      public void UpdateStreamsUI()
      {
         ...
         if (this.flowsheet.StreamManager.HasShowableInEditorGasStreamControls)
         {
         ...
         if (this.flowsheet.StreamManager.HasShowableInEditorMaterialStreamControls)
         {
      ...
      public void UpdateUnitOpsUI()
      {
         ...
         if (this.flowsheet.UnitOpManager.HasShowableInEditorAirFilterControls)
         {
         ...
         if (this.flowsheet.UnitOpManager.HasShowableInEditorBagFilterControls)
         {
         ...
         if (this.flowsheet.UnitOpManager.HasShowableInEditorCompressorControls)
         {
         ...
         if (this.flowsheet.UnitOpManager.HasShowableInEditorCoolerControls)
         {
         ...
         if (this.flowsheet.UnitOpManager.HasShowableInEditorElectrostaticPrecipitatorControls)
         {
         ...
         if (this.flowsheet.UnitOpManager.HasShowableInEditorCycloneControls)
         {
         ...
         if (this.flowsheet.UnitOpManager.HasShowableInEditorEjectorControls)
         {
         ...
         if (this.flowsheet.UnitOpManager.HasShowableInEditorWetScrubberControls)
         {
         ...
         if (this.flowsheet.UnitOpManager.HasShowableInEditorDryerControls)
         {
         ...
         if (this.flowsheet.UnitOpManager.HasShowableInEditorFanControls)
         {
         ...
         if (this.flowsheet.UnitOpManager.HasShowableInEditorHeaterControls)
         {
         ...
         if (this.flowsheet.UnitOpManager.HasShowableInEditorHeatExchangerControls)
         {
         ...
         if (this.flowsheet.UnitOpManager.HasShowableInEditorPumpControls)
         {
         ...
         if (this.flowsheet.UnitOpManager.HasShowableInEditorValveControls)
         {
