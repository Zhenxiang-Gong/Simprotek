...
namespace ProsimoUI.GlobalEditor
{
   /// <summary>
	...
	public class GasStreamsEditor : StreamsEditor
	{
      ...
      {
         return this.flowsheet.EvaporationAndDryingSystem.GetStreamList(typeof(DryingGasStream));
      }
      ...
      {
         return this.flowsheet.StreamManager.GetShowableInEditorGasStreamControls();
      }
