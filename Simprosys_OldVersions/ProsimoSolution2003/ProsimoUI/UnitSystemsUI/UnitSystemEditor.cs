...
namespace ProsimoUI.UnitSystemsUI
{
	...
	public class UnitSystemEditor : System.Windows.Forms.Form
	{
      ...
      public UnitSystemEditor(UnitSystemsControl unitSystemsCtrl)
      {
         ...
         this.comboBoxTemperature.SelectedItem = TemperatureUnit.GetUnitAsString(this.unitSystemCache.TemperatureUnitType);

         e = PressureUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxPressure.Items.Add(e.Current);
         }
         this.comboBoxPressure.SelectedItem = PressureUnit.GetUnitAsString(this.unitSystemCache.PressureUnitType);

         e = MassFlowRateUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxMassFlowRate.Items.Add(e.Current);
         }
         this.comboBoxMassFlowRate.SelectedItem = MassFlowRateUnit.GetUnitAsString(this.unitSystemCache.MassFlowRateUnitType);

         e = VolumeFlowRateUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxVolumeFlowRate.Items.Add(e.Current);
         }
         this.comboBoxVolumeFlowRate.SelectedItem = VolumeFlowRateUnit.GetUnitAsString(this.unitSystemCache.VolumeFlowRateUnitType);

         e = MoistureContentUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxMoistureContent.Items.Add(e.Current);
         }
         this.comboBoxMoistureContent.SelectedItem = MoistureContentUnit.GetUnitAsString(this.unitSystemCache.MoistureContentUnitType);

         e = FractionUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxFraction.Items.Add(e.Current);
         }
         this.comboBoxFraction.SelectedItem = FractionUnit.GetUnitAsString(this.unitSystemCache.FractionUnitType);

         e = SpecificEnergyUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxSpecificEnergy.Items.Add(e.Current);
         }
         this.comboBoxSpecificEnergy.SelectedItem = SpecificEnergyUnit.GetUnitAsString(this.unitSystemCache.SpecificEnergyUnitType);

         e = SpecificHeatUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxSpecificHeat.Items.Add(e.Current);
         }
         this.comboBoxSpecificHeat.SelectedItem = SpecificHeatUnit.GetUnitAsString(this.unitSystemCache.SpecificHeatUnitType);

         e = EnergyUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxEnergy.Items.Add(e.Current);
         }
         this.comboBoxEnergy.SelectedItem = EnergyUnit.GetUnitAsString(this.unitSystemCache.EnergyUnitType);

         e = PowerUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxPower.Items.Add(e.Current);
         }
         this.comboBoxPower.SelectedItem = PowerUnit.GetUnitAsString(this.unitSystemCache.PowerUnitType);

         e = DensityUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxDensity.Items.Add(e.Current);
         }
         this.comboBoxDensity.SelectedItem = DensityUnit.GetUnitAsString(this.unitSystemCache.DensityUnitType);

         e = DynamicViscosityUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxDynamicViscosity.Items.Add(e.Current);
         }
         this.comboBoxDynamicViscosity.SelectedItem = DynamicViscosityUnit.GetUnitAsString(this.unitSystemCache.DynamicViscosityUnitType);

         e = KinematicViscosityUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxKinematicViscosity.Items.Add(e.Current);
         }
         this.comboBoxKinematicViscosity.SelectedItem = KinematicViscosityUnit.GetUnitAsString(this.unitSystemCache.KinematicViscosityUnitType);

         e = ThermalConductivityUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxThermalConductivity.Items.Add(e.Current);
         }
         this.comboBoxThermalConductivity.SelectedItem = ThermalConductivityUnit.GetUnitAsString(this.unitSystemCache.ThermalConductivityUnitType);

         e = DiffusivityUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxDiffusivity.Items.Add(e.Current);
         }
         this.comboBoxDiffusivity.SelectedItem = DiffusivityUnit.GetUnitAsString(this.unitSystemCache.DiffusivityUnitType);

         e = MassUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxMass.Items.Add(e.Current);
         }
         this.comboBoxMass.SelectedItem = MassUnit.GetUnitAsString(this.unitSystemCache.MassUnitType);

         e = LengthUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxLength.Items.Add(e.Current);
         }
         this.comboBoxLength.SelectedItem = LengthUnit.GetUnitAsString(this.unitSystemCache.LengthUnitType);

         e = AreaUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxArea.Items.Add(e.Current);
         }
         this.comboBoxArea.SelectedItem = AreaUnit.GetUnitAsString(this.unitSystemCache.AreaUnitType);

         e = VolumeUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxVolume.Items.Add(e.Current);
         }
         this.comboBoxVolume.SelectedItem = VolumeUnit.GetUnitAsString(this.unitSystemCache.VolumeUnitType);

         e = TimeUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxTime.Items.Add(e.Current);
         }
         this.comboBoxTime.SelectedItem = TimeUnit.GetUnitAsString(this.unitSystemCache.TimeUnitType);

         e = SmallLengthUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxSmallLength.Items.Add(e.Current);
         }
         this.comboBoxSmallLength.SelectedItem = SmallLengthUnit.GetUnitAsString(this.unitSystemCache.SmallLengthUnitType);

         e = MicroLengthUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxMicroLength.Items.Add(e.Current);
         }
         this.comboBoxMicroLength.SelectedItem = MicroLengthUnit.GetUnitAsString(this.unitSystemCache.MicroLengthUnitType);

         e = LiquidHeadUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxLiquidHead.Items.Add(e.Current);
         }
         this.comboBoxLiquidHead.SelectedItem = LiquidHeadUnit.GetUnitAsString(this.unitSystemCache.LiquidHeadUnitType);

         e = VolumeRateFlowLiquidsUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxVolumeRateFlowLiquids.Items.Add(e.Current);
         }
         this.comboBoxVolumeRateFlowLiquids.SelectedItem = VolumeRateFlowLiquidsUnit.GetUnitAsString(this.unitSystemCache.VolumeRateFlowLiquidsUnitType);

         e = VolumeRateFlowGasesUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxVolumeRateFlowGases.Items.Add(e.Current);
         }
         this.comboBoxVolumeRateFlowGases.SelectedItem = VolumeRateFlowGasesUnit.GetUnitAsString(this.unitSystemCache.VolumeRateFlowGasesUnitType);
      
         e = HeatTransferCoefficientUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxHeatTransferCoeff.Items.Add(e.Current);
         }
         this.comboBoxHeatTransferCoeff.SelectedItem = HeatTransferCoefficientUnit.GetUnitAsString(this.unitSystemCache.HeatTransferCoefficientUnitType);
      
         e = SurfaceTensionUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxSurfaceTension.Items.Add(e.Current);
         }
         this.comboBoxSurfaceTension.SelectedItem = SurfaceTensionUnit.GetUnitAsString(this.unitSystemCache.SurfaceTensionUnitType);
      
         e = VelocityUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxVelocity.Items.Add(e.Current);
         }
         this.comboBoxVelocity.SelectedItem = VelocityUnit.GetUnitAsString(this.unitSystemCache.VelocityUnitType);
      
         e = FoulingFactorUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxFoulingFactor.Items.Add(e.Current);
         }
         this.comboBoxFoulingFactor.SelectedItem = FoulingFactorUnit.GetUnitAsString(this.unitSystemCache.FoulingFactorUnitType);
      
         e = SpecificVolumeUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxSpecificVolume.Items.Add(e.Current);
         }
         this.comboBoxSpecificVolume.SelectedItem = SpecificVolumeUnit.GetUnitAsString(this.unitSystemCache.SpecificVolumeUnitType);

         e = MassVolumeConcentrationUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxMassVolumeConcentration.Items.Add(e.Current);
         }
         this.comboBoxMassVolumeConcentration.SelectedItem = MassVolumeConcentrationUnit.GetUnitAsString(this.unitSystemCache.MassVolumeConcentrationUnitType);

         e = PlaneAngleUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxPlaneAngle.Items.Add(e.Current);
         }
         this.comboBoxPlaneAngle.SelectedItem = PlaneAngleUnit.GetUnitAsString(this.unitSystemCache.PlaneAngleUnitType);

         e = VolumeHeatTransferCoefficientUnit.GetUnitsAsStrings().GetEnumerator();
         while (e.MoveNext())
         {
            this.comboBoxVolumeHeatTransferCoefficient.Items.Add(e.Current);
         }
         this.comboBoxVolumeHeatTransferCoefficient.SelectedItem = VolumeHeatTransferCoefficientUnit.GetUnitAsString(this.unitSystemCache.VolumeHeatTransferCoefficientUnitType);
      }
...
//      }
      ...
      private void comboBoxTemperature_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ...
         this.unitSystemCache.TemperatureUnitType = TemperatureUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxPressure_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.PressureUnitType = PressureUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxMassFlowRate_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.MassFlowRateUnitType = MassFlowRateUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxVolumeFlowRate_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.VolumeFlowRateUnitType = VolumeFlowRateUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxMoistureContent_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.MoistureContentUnitType = MoistureContentUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxFraction_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.FractionUnitType = FractionUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxSpecificEnergy_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.SpecificEnergyUnitType = SpecificEnergyUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxSpecificHeat_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.SpecificHeatUnitType = SpecificHeatUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxEnergy_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.EnergyUnitType = EnergyUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxPower_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.PowerUnitType = PowerUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxDensity_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.DensityUnitType = DensityUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxDynamicViscosity_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.DynamicViscosityUnitType = DynamicViscosityUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxKinematicViscosity_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.KinematicViscosityUnitType = KinematicViscosityUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxThermalConductivity_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.ThermalConductivityUnitType = ThermalConductivityUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxDiffusivity_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.DiffusivityUnitType = DiffusivityUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxMass_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.MassUnitType = MassUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxLength_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.LengthUnitType = LengthUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxArea_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.AreaUnitType = AreaUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxVolume_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.VolumeUnitType = VolumeUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxTime_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.TimeUnitType = TimeUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxSmallLength_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.SmallLengthUnitType = SmallLengthUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxMicroLength_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.MicroLengthUnitType = MicroLengthUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxLiquidHead_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.LiquidHeadUnitType = LiquidHeadUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxVolumeRateFlowLiquids_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.VolumeRateFlowLiquidsUnitType = VolumeRateFlowLiquidsUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxVolumeRateFlowGases_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.VolumeRateFlowGasesUnitType = VolumeRateFlowGasesUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxHeatTransferCoeff_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.HeatTransferCoefficientUnitType = HeatTransferCoefficientUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxSurfaceTension_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.SurfaceTensionUnitType = SurfaceTensionUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxVelocity_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.VelocityUnitType = VelocityUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxFoulingFactor_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.FoulingFactorUnitType = FoulingFactorUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxSpecificVolume_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.SpecificVolumeUnitType = SpecificVolumeUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxMassVolumeConcentration_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.MassVolumeConcentrationUnitType = MassVolumeConcentrationUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxPlaneAngle_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.PlaneAngleUnitType = PlaneAngleUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }

      private void comboBoxVolumeHeatTransferCoefficient_SelectedIndexChanged(object sender, System.EventArgs e)
      {
         ComboBox cb = (ComboBox)sender;
         this.unitSystemCache.VolumeHeatTransferCoefficientUnitType = VolumeHeatTransferCoefficientUnit.GetUnitAsEnum((string)cb.SelectedItem);
      }
