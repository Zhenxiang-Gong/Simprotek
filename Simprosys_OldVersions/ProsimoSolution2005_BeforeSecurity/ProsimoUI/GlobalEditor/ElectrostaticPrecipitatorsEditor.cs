...
namespace ProsimoUI.GlobalEditor
{
   ...
   public class ElectrostaticPrecipitatorsEditor : UnitOpsEditor
   {
      ...
      {
         return this.flowsheet.EvaporationAndDryingSystem.GetUnitOpList(typeof(ElectrostaticPrecipitator));
      }
      ...
      {
         return this.flowsheet.UnitOpManager.GetShowableInEditorElectrostaticPrecipitatorControls();
      }
