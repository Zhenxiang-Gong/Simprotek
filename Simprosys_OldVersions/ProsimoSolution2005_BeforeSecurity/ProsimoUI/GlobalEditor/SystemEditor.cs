...
namespace ProsimoUI.GlobalEditor
{
	...
	{
      private const string EVAPORATION_DRYING_SYSTEM = "Edit Process Data";
      ...
      private void PrepareToPrint()
      {
         ...
         list = this.flowsheet.UnitOpManager.GetShowableInEditorScrubberCondenserControls();
         this.AddListToStringBuilder(list, sb);
      ...
      public void UpdateUnitOpsUI()
      {
         ...
         if (this.flowsheet.UnitOpManager.HasShowableInEditorScrubberCondenserControls)
         {
