...
namespace ProsimoUI.GlobalEditor
{
	...
	public class AirFiltersEditor : UnitOpsEditor
	{
      ...
      {
         return this.flowsheet.EvaporationAndDryingSystem.GetUnitOpList(typeof(AirFilter));
      }
      ...
      {
         return this.flowsheet.UnitOpManager.GetShowableInEditorAirFilterControls();
      }
