...
namespace ProsimoUI.UnitOperationsUI.CycloneUI
{
	...
	public class CycloneValuesControl : System.Windows.Forms.UserControl
	{
      ...
      {
         this.textBoxPressureDrop.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.Cyclone.GasPressureDrop);
         this.textBoxMassFlowRateOfParticleLostToGasOutlet.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.Cyclone.MassFlowRateOfParticleLostToGasOutlet);
         this.textBoxInletParticleLoading.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.Cyclone.InletParticleLoading);
         this.textBoxOutletParticleLoading.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.Cyclone.OutletParticleLoading);
         this.textBoxCollectionEfficiency.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.Cyclone.CollectionEfficiency);
      }
