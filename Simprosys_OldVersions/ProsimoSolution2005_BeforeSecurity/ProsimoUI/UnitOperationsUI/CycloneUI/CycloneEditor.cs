...
namespace ProsimoUI.UnitOperationsUI.CycloneUI
{
	...
	public class CycloneEditor : UnitOpEditor
	{
      ...
      /// <summary>
		...
		public CycloneEditor(CycloneControl cycloneCtrl) : base(cycloneCtrl)
		{
			//
         ...
         this.groupBoxCyclone.Size = new System.Drawing.Size(280, 140);
         ...
         {
            this.groupBoxParticle.Size = new System.Drawing.Size(280, 280);
            this.panel.Size = new System.Drawing.Size(930, 309);
		...
		private void InitializeComponent()
		{
         ...
         this.groupBoxMixtureFluid.Text = "Mixture Inlet/Fluid Outlet";
         // 
         // textBoxGasOutName
         // 
      ...
      private void comboBoxCalculationType_SelectedIndexChanged(object sender, EventArgs e)
      {
         if (!this.inConstruction)
         {
            ...
            if (idx == CycloneEditor.INDEX_BALANCE)
            {
            ...
            else if (idx == CycloneEditor.INDEX_RATING)
            {
