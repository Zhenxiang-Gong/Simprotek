...
namespace ProsimoUI.UnitOperationsUI.TwoStream
{
   ...
   public class ElectrostaticPrecipitatorValuesControl : System.Windows.Forms.UserControl
   {
      ...
      {
         this.textBoxPressureDrop.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.ElectrostaticPrecipitator.GasPressureDrop);
         this.textBoxInletParticleLoading.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.ElectrostaticPrecipitator.InletParticleLoading);
         this.textBoxOutletParticleLoading.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.ElectrostaticPrecipitator.OutletParticleLoading);
         this.textBoxParticleCollectionRate.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.ElectrostaticPrecipitator.ParticleCollectionRate);
         this.textBoxCollectionEfficiency.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.ElectrostaticPrecipitator.CollectionEfficiency);
         this.textBoxDriftVelocity.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.ElectrostaticPrecipitator.DriftVelocity);
         this.textBoxTotalSurfaceArea.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.ElectrostaticPrecipitator.TotalSurfaceArea);
         this.textBoxMassFlowRateOfParticleLostToGasOutlet.InitializeVariable(ctrl.Flowsheet.ApplicationPrefs, ctrl.ElectrostaticPrecipitator.MassFlowRateOfParticleLostToGasOutlet);
      }
