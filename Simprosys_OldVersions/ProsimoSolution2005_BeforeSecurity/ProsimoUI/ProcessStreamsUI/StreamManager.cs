...
namespace ProsimoUI.ProcessStreamsUI
{
	...
	public class StreamManager
	{
      ...
      public bool HasGasStreamControls
      {
         get
         {
            if (this.GetStreamControls<GasStreamControl>().Count > 0)
               return true;
            else
               return false;
         }
      ...
      public bool HasMaterialStreamControls
      {
         get
         {
            if (this.GetStreamControls<MaterialStreamControl>().Count > 0)
               return true;
            else
               return false;
         }
      ...
      public bool HasProcessStreamControls
      {
         get
         {
            if (this.GetStreamControls<ProcessStreamControl>().Count > 0)
               return true;
            else
               return false;
         }
