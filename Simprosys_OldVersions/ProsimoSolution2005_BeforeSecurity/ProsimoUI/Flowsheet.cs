...
namespace ProsimoUI
{
   ...
   /// </summary>
   public class Flowsheet : System.Windows.Forms.Panel
   {
...
//               MessageBox.Show(message, "New Flowsheet Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            if (dm == null)
            {
               string message = "You need to set a drying material in Materials / New Process Settings first!";
               MessageBox.Show(message, "New Flowsheet Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
      ...
      {
         this.Parent.Text = Application.ProductName + " - " + name;
      }
...
//         this.Paint += new System.Windows.Forms.PaintEventHandler(this.Flowsheet_Paint);
         ...
         this.DragLeave += new EventHandler(Flowsheet_DragLeave);
         this.SizeChanged += new EventHandler(Flowsheet_SizeChanged);
         this.Enter += new EventHandler(Flowsheet_Enter);
