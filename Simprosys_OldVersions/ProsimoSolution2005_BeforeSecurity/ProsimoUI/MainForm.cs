...
namespace ProsimoUI
{
	...
	public class MainForm : System.Windows.Forms.Form
	{
      ...
      private MenuItem menuItemApplicationPreferences;
      ...
      /// <summary>
		...
		private void InitializeComponent()
		{
         ...
         this.menuItemApplicationPreferences = new System.Windows.Forms.MenuItem();
         ...
         this.menuItemEdit.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {
            ...
            this.menuItem12,
            this.menuItemApplicationPreferences});
         this.menuItemEdit.Text = "Edit";
         // 
         // menuItemEditProcessData
         // 
         this.menuItemEditProcessData.Index = 0;
         this.menuItemEditProcessData.Text = "Process Data...";
         ...
         this.menuItemSelectedProcessData.Text = "Selected Process Data...";
         ...
         // 
         // menuItemApplicationPreferences
         // 
         this.menuItemApplicationPreferences.Index = 10;
         this.menuItemApplicationPreferences.Text = "Application Preferences...";
         this.menuItemApplicationPreferences.Click += new System.EventHandler(this.menuItemApplicationPreferences_Click);
         // 
         // menuItemView
         // 
         ...
         this.menuItemNewProcessSettings.Text = "New Process Settings...";
         ...
         this.toolBarButtonFlowsheetPreferences.Name = "toolBarButtonFlowsheetPreferences";
      ...
      private void NewFlowsheet()
      {
         ...
         if (this.flowsheet == null)
         {
            if (IsOkToCreateNewFlowsheet())
            {
               ...
               this.Text = Application.ProductName + " - " + UI.NEW_SYSTEM;
            }
         }
      }
      ...
      private bool IsOkToCreateNewFlowsheet()
      {
         ...
         if (this.newProcessSettings.DryingMaterialName == null || this.newProcessSettings.DryingMaterialName.Trim().Equals(""))
         {
            if (DryingMaterialCatalog.GetInstance().IsEmpty)
            {
               ...
               switch (dr)
               {
                  case System.Windows.Forms.DialogResult.Yes:
                     ...
                     string message2 = "You need to set a drying material in Materials / New Process Settings";
                     ...
                     {
                        string message3 = "You need to set a drying material in Materials / New Process Settings first!";
            ...
            {
               string message = "You need to set a drying material in Materials / New Process Settings";
               ...
               while (!DryingMaterialCatalog.GetInstance().IsInCatalog(this.newProcessSettings.DryingMaterialName))
               {
                  string message4 = "You need to set a drying material in Materials / New Process Settings first!";
         ...
         else
         {
            ...
            else
            {
               ...
               while (!DryingMaterialCatalog.GetInstance().IsInCatalog(this.newProcessSettings.DryingMaterialName))
               {
                  string message5 = "You need to set a drying material in Materials / New Process Settings first!";
               ...
               if (fileName != null && fileName.Length > 0)
               {
                  ...
                  if (fext.Equals("." + UI.FILE_EXT))
                  {
                     ...
                     if (this.flowsheet != null)
                     {
                        ...
                        this.Text = Application.ProductName + " - " + flowsheetName;
      ...
      {
         UnitSystemsForm unitSysEditor = new UnitSystemsForm(this);
      ...
      private void FlowsheetPreferences()
      {
         if (this.flowsheet != null)
         {
            FlowsheetOptionsForm prefs = new FlowsheetOptionsForm(this.flowsheet);
            prefs.ShowDialog();
         }
      }
...
//                  form2.ShowDialog();
      ...
      private void menuItemApplicationPreferences_Click(object sender, EventArgs e)
      {
         ApplicationPreferencesForm prefs = new ApplicationPreferencesForm(this, this.appPrefs);
         prefs.ShowDialog();
      }
