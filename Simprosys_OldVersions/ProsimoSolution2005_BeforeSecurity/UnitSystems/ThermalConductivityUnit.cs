...
namespace Prosimo.UnitSystems
{
   ...
   public class ThermalConductivityUnit {
      ...
      static ThermalConductivityUnit() {
         ...
         coeffTable.Add(ThermalConductivityUnitType.KilojoulePerHourMeterKelvin, 1.0/3.6);            unitStringTable.Add(ThermalConductivityUnitType.KilojoulePerHourMeterKelvin, "kJ/hr.m.K");
         coeffTable.Add(ThermalConductivityUnitType.CaloryPerCentimeterHourCelsius, 0.116222222);     unitStringTable.Add(ThermalConductivityUnitType.CaloryPerCentimeterHourCelsius, "cal/cm.hr.°C");
         ...
         coeffTable.Add(ThermalConductivityUnitType.KilocaloryPerMeterHourCelsius, 1.16222222);       unitStringTable.Add(ThermalConductivityUnitType.KilocaloryPerMeterHourCelsius, "kcal/m.hr.°C");
         ...
         coeffTable.Add(ThermalConductivityUnitType.BtuInchPerSquareFootHourFahrenheit, 0.144227889); unitStringTable.Add(ThermalConductivityUnitType.BtuInchPerSquareFootHourFahrenheit, "Btu.in/ft2.hr.°F");
         coeffTable.Add(ThermalConductivityUnitType.BtuPerInchHourFahrenheit, 20.768816);             unitStringTable.Add(ThermalConductivityUnitType.BtuPerInchHourFahrenheit, "Btu/in.hr.°F");
         ...
         coeffTable.Add(ThermalConductivityUnitType.BtuPerFootHourFahrenheit, 1.73073467);            unitStringTable.Add(ThermalConductivityUnitType.BtuPerFootHourFahrenheit, "Btu/ft.hr.°F");
      }

      public static double ConvertToSIValue(ThermalConductivityUnitType unitType, double toBeConvertedValue) {
         double convertionCoeff = (double) coeffTable[unitType];
         return convertionCoeff * toBeConvertedValue;
      }
      
      public static double ConvertFromSIValue(ThermalConductivityUnitType unitType, double wattPerMKValue) {
         double convertionCoeff = (double) coeffTable[unitType];
         return wattPerMKValue/convertionCoeff;
      }
      
      public static string GetUnitAsString(ThermalConductivityUnitType unitType) {
         return unitStringTable[unitType] as String;
      }
  
      public static ThermalConductivityUnitType GetUnitAsEnum(string unitString) {
         IDictionaryEnumerator myEnumerator = unitStringTable.GetEnumerator();
         String name;
         ThermalConductivityUnitType type = ThermalConductivityUnitType.WattPerMeterKelvin;
         while (myEnumerator.MoveNext()) {
            name = myEnumerator.Value as String;
            if (name.Equals(unitString)) {
               type = (ThermalConductivityUnitType) myEnumerator.Key;
               break;
            }
         }
         return type;
