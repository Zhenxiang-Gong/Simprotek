...
namespace Prosimo.UnitSystems
{
   ...
   public class SpecificHeatUnit {
      ...
      static SpecificHeatUnit() {
         ...
         coeffTable.Add(SpecificHeatUnitType.KilowattHourPerKgCelsius, 3.6e6);       unitStringTable.Add(SpecificHeatUnitType.KilowattHourPerKgCelsius, "kW.hr/kg.°C");
         coeffTable.Add(SpecificHeatUnitType.JoulePerPoundCelsius, 2.20462262);      unitStringTable.Add(SpecificHeatUnitType.JoulePerPoundCelsius, "J/Ibm.°C");
         ...
         coeffTable.Add(SpecificHeatUnitType.BtuPerPoundFahrenheit, 4186.8);         unitStringTable.Add(SpecificHeatUnitType.BtuPerPoundFahrenheit, "Btu/Ibm.°F");
         coeffTable.Add(SpecificHeatUnitType.BtuPerPoundCelcius, 2326.0);            unitStringTable.Add(SpecificHeatUnitType.BtuPerPoundCelcius, "Btu/Ibm.°C");
         coeffTable.Add(SpecificHeatUnitType.FootIbfPerPoundFahrenheit, 5.38032046); unitStringTable.Add(SpecificHeatUnitType.FootIbfPerPoundFahrenheit, "ft.Ibf/Ibm.°F");
         coeffTable.Add(SpecificHeatUnitType.FootIbfPerPoundCelsius, 2.98906692);    unitStringTable.Add(SpecificHeatUnitType.FootIbfPerPoundCelsius, "ft.Ibf/Ibm.°C");
