...
namespace Prosimo.UnitSystems
{
   ...
   public class DynamicViscosityUnit {
      ...
      static DynamicViscosityUnit() {
         ...
         coeffTable.Add(DynamicViscosityUnitType.KgPerMeterHour, 2.77777778e-4);         unitStringTable.Add(DynamicViscosityUnitType.KgPerMeterHour, "kg/m.hr");
         ...
         coeffTable.Add(DynamicViscosityUnitType.IbfHourPerSquareFoot, 172369.0);        unitStringTable.Add(DynamicViscosityUnitType.IbfHourPerSquareFoot, "Ibf.hr/ft2");
         coeffTable.Add(DynamicViscosityUnitType.PoundPerFootSec, 1.488164);             unitStringTable.Add(DynamicViscosityUnitType.PoundPerFootSec, "Ibm/ft.s");
         coeffTable.Add(DynamicViscosityUnitType.PoundPerFootHour, 4.133789e-4);         unitStringTable.Add(DynamicViscosityUnitType.PoundPerFootHour, "Ibm/ft.hr");
         ...
         coeffTable.Add(DynamicViscosityUnitType.SlugHourPerFootSquareSec, 172369);      unitStringTable.Add(DynamicViscosityUnitType.SlugHourPerFootSquareSec, "slug.hr/ft.s2");
      }
