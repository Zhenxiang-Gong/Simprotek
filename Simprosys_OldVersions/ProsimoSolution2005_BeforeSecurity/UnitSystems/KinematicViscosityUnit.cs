...
namespace Prosimo.UnitSystems
{
   ...
   public class KinematicViscosityUnit {
      ...
      static KinematicViscosityUnit() {
         ...
         coeffTable.Add(KinematicViscosityUnitType.SquareMeterPerHour, 1.0/3600.0);         unitStringTable.Add(KinematicViscosityUnitType.SquareMeterPerHour, "m2/hr");
         ...
         coeffTable.Add(KinematicViscosityUnitType.SquareCentimeterPerHour, 2.77777778e-8); unitStringTable.Add(KinematicViscosityUnitType.SquareCentimeterPerHour, "cm2/hr");
         ...
         coeffTable.Add(KinematicViscosityUnitType.SquareInchPerHour, 1.79211111e-7);       unitStringTable.Add(KinematicViscosityUnitType.SquareInchPerHour, "in2/hr");
         ...
         coeffTable.Add(KinematicViscosityUnitType.SquareFootPerHour, 2.58064e-5);          unitStringTable.Add(KinematicViscosityUnitType.SquareFootPerHour, "ft2/hr");
         coeffTable.Add(KinematicViscosityUnitType.PoiseCubicFootPerPound, 0.00624279606);  unitStringTable.Add(KinematicViscosityUnitType.PoiseCubicFootPerPound, "poise.ft3/Ibm");
      }

      public static double ConvertToSIValue(KinematicViscosityUnitType unitType, double toBeConvertedValue) {
         double convertionCoeff = (double) coeffTable[unitType];
         return convertionCoeff * toBeConvertedValue;
      }
      
      public static double ConvertFromSIValue(KinematicViscosityUnitType unitType, double sqMeterPersecSecValue) {
         double convertionCoeff = (double) coeffTable[unitType];
         return sqMeterPersecSecValue/convertionCoeff;
      }
      
      public static string GetUnitAsString(KinematicViscosityUnitType unitType) {
         return unitStringTable[unitType] as String;
      }
   
      public static KinematicViscosityUnitType GetUnitAsEnum(string unitString) {
         IDictionaryEnumerator myEnumerator = unitStringTable.GetEnumerator();
         String name;
         KinematicViscosityUnitType type = KinematicViscosityUnitType.SquareMeterPerSec;
         while (myEnumerator.MoveNext()) {
            name = myEnumerator.Value as String;
            if (name.Equals(unitString)) {
               type = (KinematicViscosityUnitType) myEnumerator.Key;
               break;
            }
         }
         return type;
