...
namespace Prosimo.UnitSystems
{
   ...
   public class VolumeFlowRateUnit {
      ...
      static VolumeFlowRateUnit() {
         ...
         coeffTable.Add(VolumeFlowRateUnitType.CubicMeterPerHour, 1.0/3600.0);   unitStringTable.Add(VolumeFlowRateUnitType.CubicMeterPerHour, "m3/hr");
         //1 day = 86400 sec
         ...
         coeffTable.Add(VolumeFlowRateUnitType.LitrePerHour, 1.0/3.6e6);         unitStringTable.Add(VolumeFlowRateUnitType.LitrePerHour, "L/hr");
         ...
         coeffTable.Add(VolumeFlowRateUnitType.BblPerHour, 4.416314e-5);         unitStringTable.Add(VolumeFlowRateUnitType.BblPerHour, "bbl/hr");
         ...
         coeffTable.Add(VolumeFlowRateUnitType.CubicFootPerHour, 7.86579072e-6); unitStringTable.Add(VolumeFlowRateUnitType.CubicFootPerHour, "ft3/hr");
         ...
         coeffTable.Add(VolumeFlowRateUnitType.CubicYardPerHour, 2.12376349e-4); unitStringTable.Add(VolumeFlowRateUnitType.CubicYardPerHour, "yd3/hr");
         ...
         coeffTable.Add(VolumeFlowRateUnitType.GallonUKPerHour, 1.26280278e-6);  unitStringTable.Add(VolumeFlowRateUnitType.GallonUKPerHour, "UK gal/hr");
         ...
         coeffTable.Add(VolumeFlowRateUnitType.GallonUSPerHour, 1.05150327e-6);  unitStringTable.Add(VolumeFlowRateUnitType.GallonUSPerHour, "US gal/hr");
         ...
         coeffTable.Add(VolumeFlowRateUnitType.BarrelPerHour, 4.41631375e-5);    unitStringTable.Add(VolumeFlowRateUnitType.BarrelPerHour, "barrel/hr");
