...
namespace Prosimo.UnitSystems
{
   ...
   public class SpecificVolumeUnit {
      ...
      static SpecificVolumeUnit() {
         ...
         coeffTable.Add(SpecificVolumeUnitType.CubicInchPerPound, 1.0/27679.9047); unitStringTable.Add(SpecificVolumeUnitType.CubicInchPerPound, "in3/Ibm");
         coeffTable.Add(SpecificVolumeUnitType.CubicFootPerPound, 1.0/16.0184634); unitStringTable.Add(SpecificVolumeUnitType.CubicFootPerPound, "ft3/Ibm");
         ...
         coeffTable.Add(SpecificVolumeUnitType.GallonUKPerPound, 1.0/99.7763288);  unitStringTable.Add(SpecificVolumeUnitType.GallonUKPerPound, "UK gal/Ibm");
         ...
         coeffTable.Add(SpecificVolumeUnitType.GallonUSPerPound, 1.0/119.826427);  unitStringTable.Add(SpecificVolumeUnitType.GallonUSPerPound, "US gal/Ibm");
      }

      public static double ConvertToSIValue(SpecificVolumeUnitType unitType, double toBeConvertedValue) {
         double convertionCoeff = (double) coeffTable[unitType];
         return convertionCoeff * toBeConvertedValue;
      }
      
      public static double ConvertFromSIValue(SpecificVolumeUnitType unitType, double cuMPerKgValue) {
         double convertionCoeff = (double) coeffTable[unitType];
         return cuMPerKgValue/convertionCoeff;
      }
      
      public static string GetUnitAsString(SpecificVolumeUnitType unitType) {
         return unitStringTable[unitType] as String;
      }

      public static SpecificVolumeUnitType GetUnitAsEnum(string unitString) {
         IDictionaryEnumerator myEnumerator = unitStringTable.GetEnumerator();
         String name;
         SpecificVolumeUnitType type = SpecificVolumeUnitType.CubicMeterPerKg;
         while (myEnumerator.MoveNext()) {
            name = myEnumerator.Value as String;
            if (name.Equals(unitString)) {
               type = (SpecificVolumeUnitType) myEnumerator.Key;
               break;
            }
         }
         return type;
