...
namespace Prosimo.UnitSystems
{
   ...
   public class VolumeRateFlowLiquidsUnit {
      ...
      static VolumeRateFlowLiquidsUnit() {
         ...
         coeffTable.Add(VolumeRateFlowLiquidsUnitType.CubicMeterPerHour, 1.0/3600.0);   unitStringTable.Add(VolumeRateFlowLiquidsUnitType.CubicMeterPerHour, "m3/hr");
         //1 day = 86400 sec                                                            
         ...
         coeffTable.Add(VolumeRateFlowLiquidsUnitType.LitrePerHour, 1.0/3.6e6);         unitStringTable.Add(VolumeRateFlowLiquidsUnitType.LitrePerHour, "L/hr");
         ...
         coeffTable.Add(VolumeRateFlowLiquidsUnitType.BblPerHour, 4.416314e-5);         unitStringTable.Add(VolumeRateFlowLiquidsUnitType.BblPerHour, "bbl/hr");
         ...
         coeffTable.Add(VolumeRateFlowLiquidsUnitType.CubicFootPerHour, 7.86579072e-6); unitStringTable.Add(VolumeRateFlowLiquidsUnitType.CubicFootPerHour, "ft3/hr");
         ...
         coeffTable.Add(VolumeRateFlowLiquidsUnitType.CubicYardPerHour, 2.12376349e-4); unitStringTable.Add(VolumeRateFlowLiquidsUnitType.CubicYardPerHour, "yd3/hr");
         ...
         coeffTable.Add(VolumeRateFlowLiquidsUnitType.GallonUKPerHour, 1.26280278e-6);  unitStringTable.Add(VolumeRateFlowLiquidsUnitType.GallonUKPerHour, "UK gal/hr");
         ...
         coeffTable.Add(VolumeRateFlowLiquidsUnitType.GallonUSPerHour, 1.05150327e-6);  unitStringTable.Add(VolumeRateFlowLiquidsUnitType.GallonUSPerHour, "US gal/hr");
         ...
         coeffTable.Add(VolumeRateFlowLiquidsUnitType.BarrelPerHour, 4.41631375e-5);    unitStringTable.Add(VolumeRateFlowLiquidsUnitType.BarrelPerHour, "barrel/hr");
