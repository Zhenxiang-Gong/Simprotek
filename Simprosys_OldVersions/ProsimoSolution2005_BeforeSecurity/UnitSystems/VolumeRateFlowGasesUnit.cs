...
namespace Prosimo.UnitSystems
{
   ...
   public class VolumeRateFlowGasesUnit {
      ...
      static VolumeRateFlowGasesUnit() {
         ...
         coeffTable.Add(VolumeRateFlowGasesUnitType.CubicMeterPerHour, 1.0/3600.0);   unitStringTable.Add(VolumeRateFlowGasesUnitType.CubicMeterPerHour, "m3/hr");
         //1 day = 86400 sec
         ...
         coeffTable.Add(VolumeRateFlowGasesUnitType.LitrePerHour, 1.0/3.6e6);         unitStringTable.Add(VolumeRateFlowGasesUnitType.LitrePerHour, "L/hr");
         ...
         coeffTable.Add(VolumeRateFlowGasesUnitType.BblPerHour, 4.416314e-5);         unitStringTable.Add(VolumeRateFlowGasesUnitType.BblPerHour, "bbl/hr");
         ...
         coeffTable.Add(VolumeRateFlowGasesUnitType.CubicFootPerHour, 7.86579072e-6); unitStringTable.Add(VolumeRateFlowGasesUnitType.CubicFootPerHour, "ft3/hr");
         ...
         coeffTable.Add(VolumeRateFlowGasesUnitType.CubicYardPerHour, 2.12376349e-4); unitStringTable.Add(VolumeRateFlowGasesUnitType.CubicYardPerHour, "yd3/hr");
         ...
         coeffTable.Add(VolumeRateFlowGasesUnitType.GallonUKPerHour, 1.26280278e-6);  unitStringTable.Add(VolumeRateFlowGasesUnitType.GallonUKPerHour, "UK gal/hr");
         ...
         coeffTable.Add(VolumeRateFlowGasesUnitType.GallonUSPerHour, 1.05150327e-6);  unitStringTable.Add(VolumeRateFlowGasesUnitType.GallonUSPerHour, "US gal/hr");
         ...
         coeffTable.Add(VolumeRateFlowGasesUnitType.BarrelPerHour, 4.41631375e-5);    unitStringTable.Add(VolumeRateFlowGasesUnitType.BarrelPerHour, "barrel/hr");
