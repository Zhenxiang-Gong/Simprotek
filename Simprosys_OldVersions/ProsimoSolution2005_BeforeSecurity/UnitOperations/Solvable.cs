...
namespace Prosimo.UnitOperations {
   ...
   public abstract class Solvable : Storable, IProcessVarOwner, IComparable {
      ...
      protected SolveState currentSolveState;
      ...
      {
         get { return currentSolveState == SolveState.Solved; }
      }
      ...
      //constructor
      protected Solvable(UnitOperationSystem aSystem) : base() {
      ...
      internal virtual void EraseCalculatedProcVarValues() {
         ...
         currentSolveState = SolveState.NotSolved;
