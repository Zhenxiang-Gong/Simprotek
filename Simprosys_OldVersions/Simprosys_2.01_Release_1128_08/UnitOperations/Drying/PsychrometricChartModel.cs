...
namespace Prosimo.UnitOperations.Drying {
   ...
   public class PsychrometricChartModel : UnitOperation {
      ...
      static PsychrometricChartModel() {
         humidityScaleTable.Add("water", 0.3);
         humidityScaleTable.Add("carbon tetrachloride", 2.0);
         humidityScaleTable.Add("benzene", 2.0);
         humidityScaleTable.Add("toluene", 0.4);
         humidityScaleTable.Add("acetone", 4.0);
         humidityScaleTable.Add("methanol", 1.0);
         humidityScaleTable.Add("ethanol", 1.0);
         humidityScaleTable.Add("n-propanol", 0.3);
         humidityScaleTable.Add("isopropanol", 0.5);
         humidityScaleTable.Add("n-butanol", 0.3);
         humidityScaleTable.Add("isobutanol", 0.3);
      }
