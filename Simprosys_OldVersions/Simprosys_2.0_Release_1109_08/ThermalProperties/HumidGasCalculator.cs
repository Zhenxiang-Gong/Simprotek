...
namespace Prosimo.ThermalProperties {
   ...
   public class HumidGasCalculator {
      ...
      static HumidGasCalculator() {
         ...
         solventPsychrometricRatioTable.Add("water", 1.0);
         solventPsychrometricRatioTable.Add("carbon tetrachloride", 1.06 * 0.51);
         //solventPsychrometricRatioTable.Add("tetrachloromethane", 1.06 * 0.51);
         solventPsychrometricRatioTable.Add("benzene", 1.06 * 0.54);
         solventPsychrometricRatioTable.Add("toluene", 1.06 * 0.47);
         gasSolventPsychrometricRatioTable.Add("Air", solventPsychrometricRatioTable);
      }
