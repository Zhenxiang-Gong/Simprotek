...
namespace ProsimoUI {
   ...
   public class MainForm : System.Windows.Forms.Form {
      ...
      private string exePathName = ApplicationInformation.ApplicationStartupPath;
      ...
      private void InitializeComponent() {
         ...
         this.menuItemNewProcessSettings.Text = "Set Material for Default Flowsheet";
      ...
      private void MainForm_Load(object sender, System.EventArgs e) {
         ...
         PersistenceManager.Instance.UnpersistUnitSystemCatalog(usFileName, bakUsFileName);
         ...
         PersistenceManager.Instance.UnpersistMaterialCatalog(matFileName, bakMatFileName);

         // restore the app preferences
         PersistenceManager.Instance.UnpersistAppPreferences(this);
      ...
      private void SetupToolbox() {
         ...
         try {
            dockingManager.LoadConfigFromFile(this.exePathName + APP_CONFIG_XML);
         }
         catch (Exception) {
      ...
      private void menuItemExit_Click(object sender, System.EventArgs e) {
         string filePathAndname = this.exePathName + APP_CONFIG_XML;
      ...
      private void ClosingHandler(object sender, System.ComponentModel.CancelEventArgs e) {
         ...
         if (!this.Exit())
            ...
            //            string usFileName = this.exePathName + MainForm.USCAT_DAT;
            string bakUsFileName = this.exePathName + MainForm.USCAT_BAK;
            PersistenceManager.Instance.PersistUnitSystemCatalog(usFileName, bakUsFileName);

            // store the material catalog
            string matFileName = this.exePathName + MainForm.MATCAT_XML;
            //            string matFileName = this.exePathName + MainForm.MATCAT_DAT;
            string bakMatFileName = this.exePathName + MainForm.MATCAT_BAK;
            PersistenceManager.Instance.PersistMaterialCatalog(matFileName, bakMatFileName);

            // store the app preferences
            PersistenceManager.Instance.PersistAppPreferences(this);
         }
      }
      ...
      private void About() {
         ...
         if (lease != null) {
            sb.Append("Start of License: ");
            sb.Append(lease.LeaseStart.ToString());
            sb.Append("\r\n");

            sb.Append("End of License: ");
            sb.Append(lease.LeaseEnd.ToString());
            sb.Append("\r\n");

            sb.Append("Serial #: ");
            sb.Append(lease.SerialNumber);
            sb.Append("\r\n");
         }
         else {
            sb.Append("The license for this copy of Simprosys is not valid any more.");
            sb.Append("\r\n");
            sb.Append("Please contact support@simprotek.com to extend your licence.");
         }
