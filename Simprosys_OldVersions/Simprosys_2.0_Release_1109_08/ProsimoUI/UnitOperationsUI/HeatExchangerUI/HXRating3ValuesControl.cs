...
namespace ProsimoUI.UnitOperationsUI.HeatExchangerUI
{
	...
	public class HXRating3ValuesControl : System.Windows.Forms.UserControl
	{
      ...
      {
         this.textBoxTubeSideEntranceNozzleDiameter.InitializeVariable(flowsheet.ApplicationPrefs, rating.TubeSideEntranceNozzleDiameter);
         this.textBoxTubeSideExitNozzleDiameter.InitializeVariable(flowsheet.ApplicationPrefs, rating.TubeSideExitNozzleDiameter);
         this.textBoxShellSideEntranceNozzleDiameter.InitializeVariable(flowsheet.ApplicationPrefs, rating.ShellSideEntranceNozzleDiameter);
         this.textBoxShellSideExitNozzleDiameter.InitializeVariable(flowsheet.ApplicationPrefs, rating.ShellSideExitNozzleDiameter);
      }
