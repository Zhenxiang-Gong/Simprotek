...
namespace ProsimoUI {
   ...
   public class MainForm : System.Windows.Forms.Form {
      ...
      private SoftwareProtectionManager softwareProtectionMgr;
      private Lease lease;
      ...
      public MainForm() {
         ...
         softwareProtectionMgr = new SoftwareProtectionManager();
         this.lease = softwareProtectionMgr.Lease;
      }
      ...
      private void SaveFlowsheet() {
         if (softwareProtectionMgr.HasValidLease) {
      ...
      private void MainForm_Load(object sender, System.EventArgs e) {
         ...
         //else {
         //   ActivationForm aif = new ActivationForm();
         //   aif.Message = softwareProtectionMgr.Message;
         //   aif.ShowDialog();
         //   this.Close();
         //   Application.Exit();
         //}
