   ...
   public class Ejector : UnitOperation {
      ...
      internal override ErrorMessage CheckSpecifiedValueInContext(ProcessVarDouble pv, double aValue) {
         ...
         if (pv.VarTypeName == StringConstants.GetTypeName(StringConstants.VAPOR_FRACTION) && aValue < 0.9999) {
            ...
            if (motiveInlet.Pressure.HasValue && aValue >= motiveInlet.Pressure.Value) {
            ...
            else if (suctionInlet.Pressure.HasValue && aValue <= suctionInlet.Pressure.Value) {
            ...
            else if (dischargeOutlet.Pressure.HasValue && aValue <= dischargeOutlet.Pressure.Value) {
            ...
            if (dischargeOutlet.Pressure.HasValue && aValue <= dischargeOutlet.Pressure.Value) {
