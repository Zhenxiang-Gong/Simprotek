...
namespace Prosimo.UnitOperations.Drying {
   ...
   public abstract class Dryer : UnitOperation {
      ...
      internal override ErrorMessage CheckSpecifiedValueInContext(ProcessVarDouble pv, double aValue) {
         ...
         if (pv == gasInlet.Pressure && gasOutlet.Pressure.HasValue && aValue < gasOutlet.Pressure.Value) {
         ...
         else if (pv == gasOutlet.Pressure && gasInlet.Pressure.HasValue && aValue > gasInlet.Pressure.Value) {
         ...
         else if (pv == gasInlet.Humidity && gasOutlet.Humidity.HasValue && aValue > gasOutlet.Humidity.Value) {
         ...
         else if (pv == gasOutlet.Humidity && gasInlet.Humidity.HasValue && aValue < gasInlet.Humidity.Value) {
         ...
         else if (pv == materialInlet.MoistureContentWetBase && materialOutlet.MoistureContentWetBase.HasValue && aValue < materialOutlet.MoistureContentWetBase.Value) {
         ...
         else if (pv == materialOutlet.MoistureContentWetBase && materialInlet.MoistureContentWetBase.HasValue && aValue > materialInlet.MoistureContentWetBase.Value) {
