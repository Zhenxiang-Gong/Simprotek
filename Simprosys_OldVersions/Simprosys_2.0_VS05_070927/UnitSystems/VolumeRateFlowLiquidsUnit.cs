...
namespace Prosimo.UnitSystems
{
   ...
   /// </summary>
   public class VolumeRateFlowLiquidsUnit : EngineeringUnit {
      public static VolumeRateFlowLiquidsUnit Instance = new VolumeRateFlowLiquidsUnit();

      private VolumeRateFlowLiquidsUnit() {
