...
//               this.labelHook.ForeColor = SystemColors.ControlText;
      ...
      private void InitializeTheUI(INumericFormat iNumericFormat, DuhringLine duhringLine, bool readOnly)
      {
         ...
         if (readOnly)
         {
            ...
            this.textBoxConcentration.BackColor = SystemColors.Control;
            this.textBoxStartSolventBoilingPoint.BackColor = SystemColors.Control;
            this.textBoxStartSolutionBoilingPoint.BackColor = SystemColors.Control;
            this.textBoxEndSolventBoilingPoint.BackColor = SystemColors.Control;
            this.textBoxEndSolutionBoilingPoint.BackColor = SystemColors.Control;
         }
      }
