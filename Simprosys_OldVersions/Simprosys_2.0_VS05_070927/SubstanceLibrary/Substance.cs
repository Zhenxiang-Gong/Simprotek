...
namespace Prosimo.SubstanceLibrary {
   ...
   public class Substance : Storable {
      ...
      private CriticalPropsAndAccentricFactor criticalPropsAndAccentricFactor; //version 2
      ...
      public CriticalPropsAndAccentricFactor CriticalPropsAndAccentricFactor {
         get { return criticalPropsAndAccentricFactor; }
         set { criticalPropsAndAccentricFactor = value; }
      }
      ...
      public override void SetObjectData() {
         ...
         if (persistedClassVersion >= 2) {
            ...
            this.criticalPropsAndAccentricFactor = (CriticalPropsAndAccentricFactor)RecallStorableObject("CriticalPropsAndAccentricFactor", typeof(CriticalPropsAndAccentricFactor));
         }
      }
      ...
      public override void GetObjectData(SerializationInfo info, StreamingContext context) {
         ...
         info.AddValue("CriticalPropsAndAccentricFactor", this.criticalPropsAndAccentricFactor, typeof(CriticalPropsAndAccentricFactor));
