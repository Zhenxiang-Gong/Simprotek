   ...
   public class ScrubberCondenser : UnitOperation, IGasSolidSeparator {
      ...
      public override bool CanAttachStream(ProcessStreamBase ps, int streamIndex) {
         ...
         if (ps is DryingGasStream) {
            ...
            if (streamIndex == WATER_INLET_INDEX) {
               canAttach = true;
            }
            else if (streamIndex == WATER_OUTLET_INDEX) {
               canAttach = true;
      ...
      internal override bool IsBalanceCalcReady() {
         ...
         if (gasInlet == null || gasOutlet == null || liquidOutlet == null || 
            (includeCoolingStreams && (waterInlet == null || waterOutlet == null))) {
            isReady = false;
         }
         return isReady;
      }
      ...
      public override void SetObjectData() {
         ...
         if (persistedClassVersion >= 2) {
            ...
            this.includeCoolingStreams = info.GetBoolean("IncludeCoolingStreams");
         }
      }
      ...
      public override void GetObjectData(SerializationInfo info, StreamingContext context) {
         ...
         info.AddValue("IncludeCoolingStreams", this.includeCoolingStreams, typeof(bool));
         //version 2 addition
