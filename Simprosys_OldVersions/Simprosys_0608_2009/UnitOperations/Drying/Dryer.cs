...
namespace Prosimo.UnitOperations.Drying {
   ...
   public abstract class Dryer : UnitOperation {
      ...
      protected Dryer(string name, UnitOperationSystem uoSys)
         ...
         originalGasTemperature = new ProcessVarDouble(StringConstants.ORIGINAL_GAS_TEMPERATURE, PhysicalQuantity.Temperature, 293.15, VarState.Specified, this);
      ...
      public override void SetObjectData() {
         ...
         if (persistedClassVersion == 1) {
            this.originalGasTemperature = new ProcessVarDouble(StringConstants.ORIGINAL_GAS_TEMPERATURE, PhysicalQuantity.Temperature, 293.15, VarState.Specified, this);
