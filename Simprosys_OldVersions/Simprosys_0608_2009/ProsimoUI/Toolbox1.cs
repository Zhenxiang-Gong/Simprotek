...
namespace ProsimoUI {
   ...
   /// </summary>
   public class Toolbox1 : System.Windows.Forms.Form {
      ...
      public Toolbox1(MainForm mf, Flowsheet flowsheet) {
         this.Owner = mf;
      ...
      private void Initialization(Flowsheet flowsheet) {
         ...
         ComponentResourceManager resources = new ComponentResourceManager(typeof(Toolbox1));
      ...
      internal void RegisterFlowSheetActivity(Flowsheet fs) {
      ...
      private void InitializeComponent() {
         ...
         //   btn.Location = new System.Drawing.Point(reminder * 35, i * 35);
         //   btn.Margin = new System.Windows.Forms.Padding(0);
         //   btn.Name = solvableType.Name;
         //   btn.Size = new System.Drawing.Size(35, 35);
         //   btn.TabIndex = i;
